...
const incrPath = process.env.SEED_PATH ? resolve(process.env.SEED_PATH) : resolve("content/cangxuan-feed/field-source-mind/foundry-ingest/04-seed-knowledge-curriculum-AB-2026-09-17.json");
...
const result = { inserted: ok, skippedExisting: skipped, errors, incrementalFile: incr.length, sourceId, mode: "priority_fulltext_chunks", at: new Date().toISOString() };
writeFileSync(
  resolve("content/cangxuan-feed/field-source-mind/foundry-ingest/05-incremental-priority-fulltext-ingest.json"),
