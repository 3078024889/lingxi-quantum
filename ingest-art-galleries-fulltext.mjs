...
const incrPath = resolve(
  "content/cangxuan-feed/field-source-mind/foundry-ingest/04-seed-knowledge-incremental-art-galleries-fulltext.json"
);
...
writeFileSync(
  resolve("content/cangxuan-feed/field-source-mind/foundry-ingest/05-incremental-art-galleries-fulltext-ingest.json"),
