...
const data: ArticleData = {
  ...
  faq: [
    { q: "高我是什么？", a: "高我是你更深、更智慧、与本源相连的那部分意识，超越日常的恐惧与念头，知道你真正是谁、真正想要什么。在造翼者体系里，它与「实存体」「整体导航仪」相通。" },
