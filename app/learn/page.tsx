  ...
  return (
    <>
      ...
      <FieldConsole eyebrow="探索 · ORIGINAL KNOWLEDGE" eyebrowEn="EXPLORE · ORIGINAL KNOWLEDGE" title="探索，发现更多可能" titleEn="Explore more ways of seeing" description="发现原创文章、实践指南、梦境语言与场域叙事，让理解成为下一次创造的起点。" descriptionEn="Discover original essays, practical guides, dream language and field narratives that can become the beginning of your next creation." heroImage="/images/narratives/traveler-on-the-bridge-1.jpg" features={[{zh:"原创内容",en:"Original writing",glyph:"♧"},{zh:"真实方法",en:"Practical guides",glyph:"▣"},{zh:"中英双语",en:"Bilingual",glyph:"◇"},{zh:"持续生长",en:"Living archive",glyph:"◌"}]} aside={<><ConsoleStatus title="从这里开始" titleEn="Start here" tone="cyan"><p className="mt-3"><Bi zh="第一次进入灵犀场，建议先读“什么是意识”“如何真正显化”和“主权与完整”，再根据当下问题进入专题。" en="If this is your first visit, begin with consciousness, manifestation, and sovereignty, then enter a subject from the question that matters now." /></p></ConsoleStatus><ConsoleStatus glyph="✦" title="内容边界" titleEn="Editorial boundary"><p className="mt-3"><Bi zh="探索内容用于理解与自我观察，不替代医疗、心理、法律或财务专业意见。梦境与象征没有唯一解释。" en="Explore content supports understanding and reflection; it does not replace medical, psychological, legal or financial advice. Dreams and symbols have no single interpretation." /></p></ConsoleStatus></>}>
        ...
        <div className="lx-console-card-grid"><ConsoleCard href="/learn/what-is-consciousness" image="/images/narratives/the-infinite-self-1.jpg" title="什么是意识" titleEn="What is consciousness" description="从经验、觉察与主体性理解意识。" descriptionEn="Approach consciousness through experience, awareness and subjectivity."/><ConsoleCard href="/learn/manifestation" image="/images/narratives/manifesting-sovereign-path-1.jpg" title="如何真正显化" titleEn="How manifestation works" description="把愿景转化为状态、选择与现实行动。" descriptionEn="Translate vision into state, choice and real action."/><ConsoleCard href="/learn/dream" image="/images/narratives/at-the-well-1.jpg" title="读懂梦境语言" titleEn="Read the language of dreams" description="把梦作为个人经验的隐喻，而非固定预言。" descriptionEn="Meet dreams as personal metaphor rather than fixed prophecy."/><ConsoleCard href="/learn/inner-sovereignty" image="/images/narratives/sovereign-path-1.jpg" title="主权与完整" titleEn="Sovereignty and wholeness" description="建立不依附外部权威的内在坐标。" descriptionEn="Build an inner coordinate not dependent on external authority."/></div>
