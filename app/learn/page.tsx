...
export const metadata = {
  ...
  description:
    "灵犀的原创内容中心：显化方法与心态、解梦与梦境象征、造翼者体系与灵性成长。中英双语，含核心术语表。Manifestation, dreams, and spiritual growth — bilingual guides.",
...
const groups: Group[] = [
  ...
  },
  {
    ...
    items: [
      { href: "/learn/wingmakers", zh: "造翼者与主权性积分态体系：入门导览", en: "WingMakers & the Sovereign Integral" },
