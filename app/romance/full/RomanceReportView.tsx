...
export default function RomanceReportView({ id }: { id: string }) {
  ...
  if (status === "checking") {
    return (
      <div className="mx-auto max-w-md px-6 py-24 text-center">
        <div className="lx-glass-romance px-6 py-10">
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      <div className="flex items-center justify-between lx-glass-romance px-6 py-4">
      ...
      <div ref={reportRef} className="mt-4">
        ...
        {sections.map((content, i) => {
          const bg = `/images/romance-full/page-${(i % 4) + 1}.png`;
