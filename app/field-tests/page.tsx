...
export default function FieldTestsPage() {
  return <><Nav /><FieldConsole eyebrow="场域精测 · FIELD INSIGHTS" eyebrowEn="FIELD INSIGHTS" title="看见此刻的模式，也看见改变的入口" titleEn="See the pattern. Find the next opening." description="九个主入口都从一个真实问题开始。选择此刻最需要被照见的方向，进入专属输入、结果与报告路径。" descriptionEn="Nine main entrances begin with a real question. Choose what needs attention now, then enter its dedicated intake, result and report path." heroArtwork="field-blueprint" features={[{ zh: "九个真实入口", en: "Nine real entrances", glyph: "09" }, { zh: "结构化计算", en: "Structured calculation", glyph: "◇" }, { zh: "免费结果先可读", en: "Readable free result", glyph: "◌" }, { zh: "报告进入档案", en: "Reports enter archive", glyph: "▣" }]} aside={<><ConsoleStatus glyph="◎" title="从问题进入" titleEn="Begin with the question" tone="cyan"><p><Bi zh="如果你想看长期生命结构，从生命图谱进入；如果问题发生在一段关系里，从关系共振进入；如果只想看今天，从今日潮汐进入。" en="Choose Life Blueprint for long-term structure, Relationship Resonance for a relationship question, or Today's Tide for the present day." /></p></ConsoleStatus><ConsoleStatus glyph="▣" title="真实档案边界" titleEn="Real archive boundary"><p><Bi zh="这里只显示产品能力与入口。报告数量、进度、分数和解锁状态都必须来自你的真实账户记录。" en="This page shows capability and entrances only. Counts, progress, scores and access always come from your account records." /></p><Link href="/account" className="mt-5 inline-flex text-base text-[var(--lx-ink)]"><Bi zh="查看我的场域 →" en="View My Field →" /></Link></ConsoleStatus></>}>
    <ConsolePanel>
      <p className="text-base font-semibold uppercase tracking-[.12em] text-[var(--lx-ink)]"><Bi zh="选择入口" en="CHOOSE AN ENTRANCE" /></p>
      <h2 className="mt-3 text-2xl font-semibold text-[var(--lx-ink)]"><Bi zh="不必一次测完，从现在最真实的问题开始" en="You do not need everything at once. Begin with what is real now." /></h2>
      <p className="mt-4 max-w-4xl text-base leading-8 text-[var(--lx-muted)]"><Bi zh="八个基础产品各自生成独立结果；生命原型不是第九份孤立测评，而是在同一主体的八项证据齐备后汇流形成。关系共振内部保留亲密、商业合伙与其他关系三个选项。" en="Eight base products generate independent results. Life Archetype is not another isolated test; it forms after eight same-subject evidence streams converge. Relationship Resonance retains intimate, business and other relationship modes." /></p>
    </ConsolePanel>
