...
function buildBatches(hidden: TarotCard, present: TarotCard, future: TarotCard, practice: { zh: string }): Batch[] {
  return [
    ...
    {
      titleZh: "第二批：三牌联合公式 + 价值创造地图 + 关系生命地图", count: 3, maxTokens: 4200,
      instruction:
        ...
        "===2===\n（价值创造地图：合并说清楚两件事——这个人的财富优势具体是什么类型、最容易遇到的财富阻碍是什么；以及天赋关键词是什么、具体适合往哪几个方向发展事业（结合三张牌的特质给出2-3个具体方向，不是泛泛而谈），两部分自然衔接成一段，不要写成两个割裂的小标题，约280-320字）" +
