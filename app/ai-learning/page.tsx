...
export default function Page(){
  return <><Nav/><main className="lx10-page"><div className="lx10-wrap">
    <p className="lx10-kicker"><LxText zh="学习 SASI" en="Learning SASI" ja="学習 SASI" ko="학습 SASI" fr="SASI Études" de="Lern-SASI" es="SASI Aprendizaje" pt="SASI Aprendizagem" ar="SASI للتعلّم"/></p>
