  ...
  async function requestQuote() {
    ...
    try {
      ...
      if (!response.ok || !result.quote) {
        ...
        throw new Error(pricingError ? t(lang,"当前线路价格尚未核验，暂不启动付费任务。","This route has no verified current price; paid execution is paused.") : result.error ?? "QUOTE_FAILED");
      }
