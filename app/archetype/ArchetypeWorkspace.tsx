...
export default function ArchetypeWorkspace({ children }: { children: ReactNode }) {
  ...
  return <div className="archetype-workspace">
    <section className="archetype-workspace-input" id="archetype-progress"><h2><Bi zh="我的八流汇聚" en="My eight streams" /></h2><ArchetypeProgress onState={setProgress} />
    ...
    <section className="archetype-workspace-archive"><h2><Bi zh="生命原型 · 完整档案" en="Life Archetype · Complete archive" /></h2>
