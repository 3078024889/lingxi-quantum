...
function PersonForm({ person, setPerson, label }: { person: Person; setPerson: (p: Person) => void; label: string }) {
  ...
  return (
    <div className="lx-pdf-relation p-6">
...
export default function RelationshipFlow() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="lx-pdf-relation mt-8 p-5">
      ...
      {error && (
        <div className="lx-pdf-relation mt-4 p-4">
      ...
      <div className="lx-pdf-relation mt-3 p-3 text-center">
