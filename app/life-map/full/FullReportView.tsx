    ...
    <div className="px-6 py-20 print:py-6">
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div>
          ...
          {facts && (
            <div className="mt-8 lx-glass-lifemap p-6 backdrop-blur-xl">
...
function NumberEnergyChart({ items }: { items: { label: string; total: number }[] }) {
  ...
  return (
    <div className="mt-5 grid grid-cols-2 gap-4 lx-glass-lifemap p-5 backdrop-blur-xl">
      {items.map((it, idx) => {
...
function HumanDesignChart({ hd }: { hd: HumanDesignResult }) {
  ...
  return (
    <div className="mt-5 flex flex-col items-center gap-5 lx-glass-lifemap p-6 backdrop-blur-xl sm:flex-row sm:items-start">
...
function WuXingChart({ wx }: { wx: { wood: number; fire: number; earth: number; metal: number; water: number } }) {
  ...
  return (
    <div className="mt-5 lx-glass-lifemap p-5 backdrop-blur-xl">
...
function FrequencyChart({ scores }: { scores: { energy: number; clarity: number; alignment: number } }) {
  ...
  return (
    <div className="mt-5 grid grid-cols-3 gap-4 lx-glass-lifemap p-5 backdrop-blur-xl">
      {items.map((it, idx) => {
