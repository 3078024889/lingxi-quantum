      ...
      <main className="pt-16">
        {!id ? (
          <div className="mx-auto max-w-md px-6 py-24 text-center">
            ...
            <a
              href="/life-map"
              className="mt-8 inline-block border border-lm-violet/40 px-8 py-3 font-display text-sm uppercase tracking-widest2 text-lm-violet transition hover:border-lm-violet hover:text-bone"
            >
