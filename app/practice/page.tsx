  ...
  return (
    <>
      ...
      <FieldConsole className="practice-console" eyebrow="修炼技术 · INNER PRACTICE" eyebrowEn="INNER PRACTICE" title="修炼技术，让更好的自己成为日常" titleEn="Let a clearer self become your daily life" description="把古老觉知与现代节律结合，形成可实践、可感受、可持续的内在修炼路径。" descriptionEn="Bring ancient awareness into a contemporary rhythm through practical, felt and sustainable inner work." heroArtwork="platform-practice" features={[{zh:"呼吸节律",en:"Measured rhythm",glyph:"◌"},{zh:"每日可练",en:"Daily practice",glyph:"ϟ"},{zh:"真实记录",en:"Real journal",glyph:"▥"},{zh:"回到自己",en:"Return within",glyph:"♡"}]} aside={<><ConsoleStatus title="今日练习" titleEn="Today's practice" tone="cyan"><p className="mt-3"><Bi zh="从最简单的一次呼吸开始。记录练习中的感受，在自己的场域中回看日积月累的变化。" en="Begin with one simple breath. Record what you feel and revisit the changes in your personal field." /></p><Link href="/practice/breath" className="mt-4 inline-flex text-xs text-[var(--lx-ink)]"><Bi zh="开始量子息法 →" en="Begin Quantum Breath →" /></Link></ConsoleStatus><ConsoleStatus glyph="✦" title="修炼次序" titleEn="Practice sequence"><ul><li><Bi zh="设定当下意图" en="Set the present intention" /></li><li><Bi zh="进入身体与呼吸" en="Enter body and breath" /></li><li><Bi zh="观察而不评判" en="Observe without judgment" /></li><li><Bi zh="记录真实感受" en="Record what was felt" /></li><li><Bi zh="把清晰带回行动" en="Carry clarity into action" /></li></ul></ConsoleStatus></>}>
        <ConsolePanel>
          <div className="grid items-center gap-6 md:grid-cols-[100px_1fr]"><div className="mx-auto"><img src="/images/practice/v2/heart-reset.webp" alt="" className="h-[100px] w-[100px] rounded-full object-cover" /></div><div><p className="text-xs uppercase tracking-[.18em] text-[var(--lx-ink)]"><Bi zh="四道修炼 · 一座内在场域" en="FOUR PATHS · ONE INNER FIELD" /></p><h2 className="mt-3 text-2xl font-semibold text-[var(--lx-ink)]"><Bi zh="心为门户，万法由心而启" en="The heart is the gateway" /></h2><div className="mt-4 space-y-3 text-sm leading-7 text-[var(--lx-muted)]">
            <p>
              <Bi
