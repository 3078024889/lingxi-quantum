...
export const metadata: Metadata = {
  ...
  openGraph:{type:"website",siteName:"灵犀场 LINGXIFIELD",title:"灵犀场｜SASI AI 创作、资料智能体与实用工具",description:"从 AI 短剧、网站构建和资料智能体，到 PDF、图片、视频、OCR、字幕与隐私工具，把想法和文件直接推进到可使用的结果。",url:SITE,images:[{url:SHARE_IMAGE,width:1200,height:630,alt:"灵犀场 LINGXIFIELD"}]},
