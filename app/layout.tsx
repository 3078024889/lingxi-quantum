...
export const metadata: Metadata = {
  ...
  description:
    "灵犀（LINGXI）是一套意识显化与内在成长系统，融合意识显化（现实回路）、探索梦境、重塑潜意识（六道之门）、量子暂停呼吸、上升之心、多维叙事等实践技术，帮助你探索内在觉察、创造力与身心成长。先在意识里活成真实，现实自会随之对齐。",
  keywords: [
    "显化", "意识显化", "显化方法", "显化技巧", "现实回路", "吸引力法则",
    "解梦", "梦境解析", "周公解梦", "梦的含义", "潜意识", "潜意识改写",
    "修炼", "冥想", "量子呼吸", "量子暂停", "上升之心", "六道之门", "重塑潜意识", "探索梦境", "多维叙事", "提升频率", "脉轮", "共时性", "觉醒", "更高的自己",
    "造翼者", "WingMakers", "主权性积分态", "Sovereign Integral", "中央种族", "詹姆斯玛呼", "James Mahu",
    "诸维度", "初始创造者", "第一源头", "无限自己", "人类仪器", "整体导航仪", "源头智能",
    ...
    "Sovereign Integral", "First Source", "Human Instrument", "unconditional love",
  ],
  alternates: {
    canonical: "/",
  ...
  twitter: {
    ...
    description: "显化 · 解梦 · 修炼。一个扎根造翼者体系的意识显化系统。",
    images: ["/og.png"],
  },
...
const orgJsonLd = {
  ...
  description:
    "灵犀是一个意识显化系统，提供显化、解梦与意识修炼的引导，扎根于造翼者(WingMakers)与主权性积分态体系。Lingxi is a bilingual consciousness system for manifestation, dream interpretation, and inner practice, rooted in the WingMakers / Sovereign Integral teachings.",
  knowsAbout: [
    "意识显化", "显化方法", "现实回路", "吸引力法则", "场域解梦", "梦境解析",
    "潜意识改写", "量子暂停呼吸", "上升之心", "六道之门", "重塑潜意识", "探索梦境", "多维叙事", "提升频率", "共时性", "觉醒",
    "造翼者", "WingMakers", "主权性积分态", "Sovereign Integral", "中央种族", "詹姆斯·玛呼",
    "诸维度", "初始创造者", "第一源头", "无限自己", "人类仪器", "整体导航仪", "源头智能",
