    ...
    <>
      ...
      <main className="pt-24">
        <div className="mx-auto max-w-xl px-6 py-16">
          <div className="flex items-center justify-between gap-3 lx-pdf-daily px-6 py-4 text-center">
          ...
          <div className="mt-6 flex flex-col items-center lx-pdf-daily p-8 text-center">
          ...
          <div className="mt-4 lx-pdf-daily p-6">
          ...
          <div className="mt-8 lx-pdf-daily p-6 text-center">
