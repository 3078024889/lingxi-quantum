...
const DAILY_FAQ: BilingualFaqItem[] = [
  {
    qZh: "今日场域测试是如何形成的？", qEn: "How does the Today's Field Test form?",
...
export const metadata = {
  title: "今日场域测试 · 十二星座每日运势 | 灵犀场 Today's Field Test | Lingxi Field",
  description: "根据今天真实的月亮星座与月相天文数据，查看十二星座今日场域测试，每日更新，不需要登录。Real daily transit data for all 12 zodiac signs, updated every day.",
        ...
        <div className="mx-auto max-w-2xl px-6 py-16 text-center">
          <div className="rounded-sm border border-white/10 bg-void-deep p-6 sm:p-8">
            <p className="font-display text-sm uppercase tracking-widest2 text-lattice/80">
              <Bi zh="灵犀 · 今日场域测试" en="Lingxi · Today's Field Test" />
            </p>
