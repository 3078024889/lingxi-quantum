...
if (!layout.includes("<FieldStructure9D />") || !fieldStructure.includes("lingxifield-9d-field-structure-v316.mp4")) fail("global 9D Field Structure is not mounted");
if (!fs.existsSync(path.join(root, "public/media/lingxifield-9d-field-structure-v316.mp4"))) fail("9D Field Structure film is missing");
