...
check("9D field structure is shared through the native field navigation", /field-structure-9d/.test(fieldNavView) && /lingxifield-9d-field-structure-v316\.mp4/.test(fieldStructureView));
...
check("Life Archetype is one eight-field convergence reading, not a three-archetype product", /layer: "convergence"/.test(fieldProductCopy) && /slice\(0,1\)/.test(dendriteEngine) && !/主原型|隐藏原型|行动原型/.test(`${fieldProductCopy}\n${dendriteEngine}`));
