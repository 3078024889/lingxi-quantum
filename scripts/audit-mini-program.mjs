...
check("Stellar Trace discloses non-convergence before payment", /支付前结果边界/.test(stellarExperience) && /不以用户填写方向反推答案/.test(stellarExperience) && /不把古法里数伪换算为公里或坐标/.test(stellarExperience));
