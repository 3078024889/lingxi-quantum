...
check("Life Archetype is a versioned automatic same-subject eight-field convergence", /layer: "convergence"/.test(fieldProductCopy) && /calculateLifeArchetypeFromReports/.test(dendriteEngine) && /BASE_DENDRITE_PRODUCT_IDS/.test(dendriteEngine) && /lingxifield-life-archetype-v4/.test(`${dendriteEngine}\n${lifeArchetype}`) && /subjectId/.test(lifeArchetype));
