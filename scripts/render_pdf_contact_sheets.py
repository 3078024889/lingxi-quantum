...
TMP_DIR = ROOT / "tmp" / "v326-pdf-pages"
...
for pdf in sorted(PDF_DIR.glob("v326-*-qa.pdf")):
...
print(f"PASS V326 contact sheets: {len(list(OUT_DIR.glob('v326-*-contact-sheet.png')))}")
