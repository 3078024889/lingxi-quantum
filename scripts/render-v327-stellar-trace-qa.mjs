...
try {
  ...
  await page.click('button:has-text("展开方向资格检验")');
  ...
  if (!reportText.includes("圆周集中度") || !reportText.includes("未形成候选坐标区域") || !reportText.includes("P50 / P75 / P90")) throw new Error("V328 evidence gate is missing from the report");
