...
await page.setContent('<video id="field-video" muted autoplay playsinline><source src="http://127.0.0.1:8765/media/lingxifield-9d-field-structure-v320.mp4" type="video/mp4"></video>');
