...
const D:Record<LingxiLang,C>={
 zh:{loadFail:"读取失败",invalid:"请输入不超过该订单充值本金的有效金额。",confirm:"确认申请退回 {amount} 的未使用充值本金？退款会回到原支付渠道。",done:"退款已经由原支付渠道确认完成。",submitted:"退款已提交，申请金额已冻结，正在等待支付渠道确认。",loading:"正在读取可退款余额…",eligibleTitle:"可申请原路退款的充值订单",eligibleDesc:"只退未使用的真实充值本金。赠送额度、邀请奖励、已消耗金额和任务中冻结的金额不属于可退本金。",emptyEligible:"当前没有可申请退款的已支付余额充值订单。",principal:"余额本金",topup:"余额充值",amountLabel:"退款金额",processing:"退款处理中",submitting:"正在提交…",return:"原路退回",history:"退款记录",emptyHistory:"还没有退款记录。",completed:"已原路退回",requested:"已提交",failed:"失败，余额已释放",wechat:"微信支付",alipay:"支付宝",other:"其他支付",original:"原路退回"},
