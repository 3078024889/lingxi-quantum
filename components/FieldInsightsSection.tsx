...
type Insight = { href:string; no:string; glyph:string; zh:string; en:string; leadZh:string; leadEn:string; bodyZh:string[]; bodyEn:string[]; timeZh?:string; timeEn?:string; ctaZh:string; ctaEn:string; closingZh?:string; closingEn?:string };

// One editorial source for all eight entrances. Product pages remain the source
...
const INSIGHTS: Insight[] = [
  ...
  {href:"/resilience",no:"03",glyph:"🌱",zh:"生命韧性指数",en:"Life Resilience Index",leadZh:"当现实发生偏转，系统如何接住自己",leadEn:"How your system catches you when reality shifts",bodyZh:[
    ...
    "这些节点与你有关，因为真正能够确认它们的，是你已经走过的人生。看见自己的韧性结构，是为了更懂得如何与自己相处，也更清楚下一次变化发生时，该怎样把自己重新接住。"],bodyEn:[
    ...
    "Your lived life confirms these nodes. Seeing your resilience structure helps you relate to yourself with greater understanding and know how to catch yourself when change comes again."],timeZh:"补充更具体的降生时刻，可展开更多与时间节律相关的结构层次，让韧性节点之间更细微的连接被进一步照见。",timeEn:"A precise birth time unfolds additional layers of timing and rhythm, revealing subtler connections among your resilience nodes.",ctaZh:"展开我的生命韧性指数",ctaEn:"Unfold My Life Resilience Index"},
