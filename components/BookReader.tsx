  ...
  return (
    <div className="mx-auto max-w-2xl select-none">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 20% 0%, rgba(230,210,255,0.16), transparent 55%), radial-gradient(ellipse at 85% 15%, rgba(160,224,208,0.14), transparent 55%), linear-gradient(135deg, rgba(94,74,168,0.6) 0%, rgba(64,108,186,0.58) 100%)",
