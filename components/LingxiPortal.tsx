...
const CAPS: Cap[] = [
  ...
  },
  {
    ...
    subs: [
      ...
      { zh: "灵犀量子塔罗", en: "Lingxi Quantum Tarot", descZh: "通过象征镜像，探索此刻意识正在呈现的主题。", descEn: "Explore the theme your consciousness is presenting right now, through symbolic mirrors.", href: "/tarot" },
