...
const D:Record<LingxiLang,C>={
 zh:{scale:"输出倍率",run:"转换为 PNG",busy:"正在转换…",ready:"PNG 已生成，可以核对尺寸后下载。",error:"SVG 转换没有完成",unsafe:"这个 SVG 包含外部资源、脚本或可执行内容。为保护隐私和浏览器安全，已停止转换。",lead:"在浏览器本地把安全 SVG 渲染为 PNG，不上传文件。"},
