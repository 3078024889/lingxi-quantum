...
function preferSameTabPayment(){
 try{
  ...
  const embedded=/MicroMessenger|WeChat|QQ\/|MQQBrowser|baiduboxapp|BaiduBoxApp|BytedanceWebview|Toutiao|Aweme|TikTok|XiaoHongShu|Weibo|; wv\)|Android.*\bwv\b/i.test(ua);
  return embedded||window.matchMedia("(max-width: 820px)").matches;
 }catch{return true}
}
