...
export default function VideoDubbingWorkbench(){
 ...
 return <div className="space-y-5">
  <div className="grid gap-4 md:grid-cols-2">
   <label className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-6 text-center"><input type="file" accept="video/*,audio/*" className="hidden" disabled={busy} onChange={e=>setAndProbeFile(e.target.files?.[0]||null)}/><div className="font-medium">上传视频 / 音频</div><div className="mt-1 text-sm text-slate-500">{file?file.name:"点击选择文件"}</div></label>
