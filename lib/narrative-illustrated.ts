...
const GEOMETRY_WILL_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "四 · 半信半疑", kickerEn: "IV · Skeptical, Yet Intrigued", tagZh: "内心挣扎", tagEn: "Inner Doubt",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#160f24"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,195) scale(0.6)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "六 · 重新绘制自己的曲线", kickerEn: "VI · Redrawing Her Own Curve", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#120c20"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g stroke="#a68fc9" stroke-width="1" opacity=".5" fill="none"><path d="M150 190 Q100 170 110 140 Q120 110 150 105 Q180 100 185 75 Q190 50 160 40"/></g></svg>`,
...
const DISOBEDIENT_PARTICLE_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    { kickerZh: "一 · 一份被归档的观测误差", kickerEn: "I · A Filed-Away Observational Error", tagZh: "龠光星", tagEn: "Yueguang Star",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#0a0612"/><g stroke="#a68fc9" stroke-width=".6" opacity=".4" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g></svg>`,
    ...
    { kickerZh: "二 · 一份格外的好奇", kickerEn: "II · A Particular Curiosity", tagZh: "困惑", tagEn: "Curiosity",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#08051a"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}</svg>`,
    ...
    { kickerZh: "三 · 重新调阅原始数据", kickerEn: "III · Reviewing the Raw Data", tagZh: "求解", tagEn: "Seeking Understanding",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#0a0612"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g stroke="#a68fc9" stroke-width=".6" opacity=".5" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g></svg>`,
    ...
    { kickerZh: "四 · 场的视角", kickerEn: "IV · The Field's Perspective", tagZh: "转折的契机", tagEn: "A Chance to See Differently",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#08051a"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<circle cx="150" cy="60" r="4" fill="#fff6e8"><animate attributeName="opacity" values=".4;1;.4" dur="2s" repeatCount="indefinite"/></circle></svg>`,
    ...
    { kickerZh: "五 · 物理学与场，两种称呼", kickerEn: "V · Two Names, Physics and the Field", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#0a0612"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g stroke="#a68fc9" stroke-width=".6" opacity=".5" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g></svg>`,
    ...
    { kickerZh: "六 · 重新审视更多的\u201c误差\u201d", kickerEn: "VI · Reexamining More 'Errors'", tagZh: "行动", tagEn: "Taking Action",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#08051a"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g stroke="#a68fc9" stroke-width=".6" opacity=".5" fill="none">${Array.from({length:5}).map((_,i)=>`<circle cx="${60+i*45}" cy="150" r="10"/>`).join('')}</g></svg>`,
    ...
    { kickerZh: "七 · 一份全新的研究方向", kickerEn: "VII · A New Research Direction", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#0a0612"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${sovStars()}</svg>`,
    ...
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "值得被重新看一眼的偏离", tagEn: "A Deviation Worth a Second Look", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#0a0612"/>${sovStars()}<g stroke="#a68fc9" stroke-width=".6" opacity=".4" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g></svg>`,
...
const INNER_PARLIAMENT_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 三个熟悉的代表", kickerEn: "II · Three Familiar Delegates", tagZh: "背景", tagEn: "Context",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#160f24"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(90,180) scale(0.35)">${sovFigure()}</g><g transform="translate(150,180) scale(0.35)">${sovFigure()}</g><g transform="translate(210,180) scale(0.35)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "六 · 一个真正属于自己的决定", kickerEn: "VI · A Decision Truly Her Own", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#120c20"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,180) scale(0.65)">${sovFigure()}</g></svg>`,
...
const MIRROR_PERSONALITY_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "四 · 令人震动的重新理解", kickerEn: "IV · A Startling Reframing", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#160f24"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<rect x="120" y="70" width="60" height="90" rx="4" fill="none" stroke="#a68fc9" stroke-width="1.5" opacity=".6"/></svg>`,
    ...
    { kickerZh: "六 · 尝试整合两个自己", kickerEn: "VI · Trying to Integrate Both Selves", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#120c20"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,195) scale(0.6)">${sovFigure()}</g></svg>`,
...
const OBSERVER_EFFECT_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 压抑积累的代价", kickerEn: "II · The Cost of Accumulated Suppression", tagZh: "困扰的加深", tagEn: "The Trouble Deepens",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#160f24"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.55)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "四 · 意外的变化", kickerEn: "IV · An Unexpected Shift", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#160f24"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<circle cx="150" cy="100" r="24" fill="#e8dcff" opacity=".35"><animate attributeName="r" values="18;28;18" dur="2.5s" repeatCount="indefinite"/></circle></svg>`,
    ...
    { kickerZh: "六 · 开始练习观察", kickerEn: "VI · Beginning to Practice Observing", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#120c20"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
...
const SITTING_FEAR_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "四 · 将信将疑的尝试", kickerEn: "IV · A Skeptical Attempt", tagZh: "行动的开端", tagEn: "The Start of a Practice",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#160f24"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
...
const BREATHING_GAP_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "四 · 意外的安定感", kickerEn: "IV · An Unexpected Calm", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#160f24"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<circle cx="150" cy="100" r="18" fill="url(#sovGlow)"/></svg>`,
...
const COMMAND_INVITATION_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "六 · 意外的持久力", kickerEn: "VI · Unexpected Endurance", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#120c20"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,185) scale(0.65)">${sovFigure()}</g></svg>`,
...
const SOVEREIGNS_LAST_LESSON_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 满怀期待的提问", kickerEn: "II · A Question Full of Anticipation", tagZh: "开场", tagEn: "The Beginning",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#160f24"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "六 · 重复了很多次的话", kickerEn: "VI · A Line Repeated Many Times", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#120c20"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.65)">${sovFigure()}</g></svg>`,
