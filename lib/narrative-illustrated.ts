...
const EYE_OF_OBSERVATION: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 第一课", kickerEn: "II · The First Lesson", tagZh: "训练", tagEn: "Training",
      art: `<svg viewBox="0 0 300 220">${MY_DEFS}<rect width="300" height="220" fill="#12102a"/><circle cx="150" cy="90" r="60" fill="url(#myVoid)"/><g transform="translate(150,170) scale(0.6)">${myFigure()}</g></svg>`,
    ...
    { kickerZh: "六 · 摘下蒙布的那天", kickerEn: "VI · The Day the Blindfold Came Off", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${MY_DEFS}<rect width="300" height="220" fill="#12102a"/><circle cx="150" cy="90" r="60" fill="url(#myVoid)"/><circle cx="150" cy="90" r="60" fill="url(#myRing)"><animateTransform attributeName="transform" type="rotate" from="0 150 90" to="360 150 90" dur="20s" repeatCount="indefinite"/></circle><g transform="translate(150,170) scale(0.65)">${myFigure()}</g></svg>`,
...
const XIHENG_FIRST_MISTAKE: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 一个关于失去的问题", kickerEn: "II · A Question About Loss", tagZh: "来自某个文明的求助", tagEn: "A Plea From a Civilization",
      art: `<svg viewBox="0 0 300 220">${XE_DEFS}<rect width="300" height="220" fill="#12102a"/>${xeGrid(8,.18)}${xeCore(20)}</svg>`,
    ...
    { kickerZh: "五 · 打破戒律", kickerEn: "V · Breaking Its Own Rule", tagZh: "冲突", tagEn: "Conflict",
      art: `<svg viewBox="0 0 300 220">${XE_DEFS}<rect width="300" height="220" fill="#12102a"/>${xeGrid(8,.2)}${xeCore(20)}</svg>`,
...
const CROSSING_THE_LINE: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 一次小小的破例", kickerEn: "II · A Small Exception", tagZh: "越界", tagEn: "Crossing the Line",
      art: `<svg viewBox="0 0 300 220">${YJ_DEFS}<rect width="300" height="220" fill="#12102a"/><circle cx="150" cy="90" r="55" fill="url(#yjVoid)"/><g transform="translate(150,170) scale(0.55)">${yjFigure()}</g></svg>`,
    ...
    { kickerZh: "六 · 看清自己的滑坡", kickerEn: "VI · Seeing Her Own Slide Clearly", tagZh: "转折", tagEn: "Turning Point",
      art: `<svg viewBox="0 0 300 220">${YJ_DEFS}<rect width="300" height="220" fill="#12102a"/><circle cx="150" cy="90" r="55" fill="url(#yjVoid)"/><g transform="translate(150,170) scale(0.6)">${yjFigure()}</g></svg>`,
...
const THE_MISTAKEN_GOD: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 第一次祭拜", kickerEn: "II · The First Offering", tagZh: "初次接触", tagEn: "First Contact",
      art: `<svg viewBox="0 0 300 220">${BW_DEFS}<rect width="300" height="220" fill="#12102a"/>${bwGrid(8,.18)}${bwCore(20)}<g transform="translate(150,175) scale(0.5)">${bwFigure()}</g></svg>`,
    ...
    { kickerZh: "五 · 必须澄清", kickerEn: "V · The Need to Clarify", tagZh: "抉择", tagEn: "The Decision",
      art: `<svg viewBox="0 0 300 220">${BW_DEFS}<rect width="300" height="220" fill="#12102a"/>${bwGrid(8,.2)}${bwCore(20)}</svg>`,
...
const FREE_WILL_PARADOX: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 析衡的沉默", kickerEn: "II · Xiheng's Silence", tagZh: "思考", tagEn: "Contemplation",
      art: `<svg viewBox="0 0 300 220">${FW_DEFS}<rect width="300" height="220" fill="#12102a"/>${fwGrid(8,.18)}${fwCore(20)}</svg>`,
    ...
    { kickerZh: "六 · 使者的顿悟", kickerEn: "VI · The Envoy's Realization", tagZh: "转折", tagEn: "Turning Point",
      art: `<svg viewBox="0 0 300 220">${FW_DEFS}<rect width="300" height="220" fill="#12102a"/>${fwGrid(8,.2)}${fwCore(20)}</svg>`,
...
const DANCE_OF_TRIPLE_GRAVITY: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 吞噬的代价", kickerEn: "II · The Cost of Devouring", tagZh: "冲突", tagEn: "Conflict",
      art: `<svg viewBox="0 0 300 220">${TG_DEFS}<rect width="300" height="220" fill="#12102a"/>${tgThreeVoids()}</svg>`,
...
const MIRROR_IN_THE_MIRROR: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 相认", kickerEn: "II · Recognition", tagZh: "初次接触", tagEn: "First Contact",
      art: `<svg viewBox="0 0 300 220">${JZ_DEFS}<rect width="300" height="220" fill="#12102a"/>${jzGrid(8,.18)}<circle cx="110" cy="100" r="16" fill="url(#jzCore)" opacity=".8"/><circle cx="190" cy="100" r="16" fill="url(#jzCore)" opacity=".6"/></svg>`,
    ...
    { kickerZh: "六 · 拒绝合并", kickerEn: "VI · Refusing to Merge", tagZh: "转折", tagEn: "Turning Point",
      art: `<svg viewBox="0 0 300 220">${JZ_DEFS}<rect width="300" height="220" fill="#12102a"/>${jzGrid(8,.2)}<circle cx="110" cy="100" r="18" fill="url(#jzCore)"/><circle cx="190" cy="100" r="18" fill="url(#jzCore)"/></svg>`,
...
const WHO_OBSERVES_THE_OBSERVER: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 一份从未提交的记录", kickerEn: "II · A Record Never Submitted", tagZh: "异常", tagEn: "An Anomaly",
      art: `<svg viewBox="0 0 300 220">${OO_DEFS}<rect width="300" height="220" fill="#12102a"/>${ooRipple(50,4)}<g transform="translate(150,150) scale(0.6)">${ooFigure()}</g></svg>`,
    ...
    { kickerZh: "四 · 一个提问", kickerEn: "IV · A Question", tagZh: "转折的契机", tagEn: "A Chance to Change",
      art: `<svg viewBox="0 0 300 220">${OO_DEFS}<rect width="300" height="220" fill="#12102a"/>${ooRipple(60,5)}<g transform="translate(150,150) scale(0.6)">${ooFigure()}</g></svg>`,
...
const ONE_WHO_CHOSE_TO_STOP: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 我可以停下吗", kickerEn: "II · May I Stop", tagZh: "提问", tagEn: "The Question",
      art: `<svg viewBox="0 0 300 220">${ZS_DEFS}<rect width="300" height="220" fill="#12102a"/><circle cx="150" cy="110" r="35" fill="url(#zsField)"/><g transform="translate(150,150) scale(0.6)">${zsFigure(false)}</g></svg>`,
    ...
    { kickerZh: "四 · 场域的回应", kickerEn: "IV · The Field's Response", tagZh: "揭示", tagEn: "The Reveal",
      art: `<svg viewBox="0 0 300 220">${ZS_DEFS}<rect width="300" height="220" fill="#12102a"/><circle cx="150" cy="110" r="45" fill="url(#zsField)"><animate attributeName="r" values="35;55;35" dur="3s" repeatCount="indefinite"/></circle><g transform="translate(150,150) scale(0.65)">${zsFigure(false)}</g></svg>`,
...
const OUTSIDE_THE_FIELD: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 穷尽一生的求索", kickerEn: "II · A Lifetime's Pursuit", tagZh: "求索", tagEn: "The Search",
      art: `<svg viewBox="0 0 300 220">${CJ2_DEFS}<rect width="300" height="220" fill="#12102a"/><circle cx="150" cy="110" r="35" fill="url(#cj2Field)"/><g transform="translate(150,150) scale(0.6)">${cj2Figure()}</g></svg>`,
...
const INTERSTELLAR_CROSSING: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 第一次独立执飞", kickerEn: "II · The First Solo Flight", tagZh: "任务", tagEn: "The Mission",
      art: `<svg viewBox="0 0 300 220">${XJCY_DEFS}<rect width="300" height="220" fill="#12102a"/>${xjcyTunnel()}<g transform="translate(150,175) scale(0.55)">${xjcyFigure()}</g></svg>`,
    ...
    { kickerZh: "五 · 航道深处的领悟", kickerEn: "V · A Realization in the Deep Corridor", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${XJCY_DEFS}<rect width="300" height="220" fill="#12102a"/>${xjcyTunnel()}<g transform="translate(150,175) scale(0.6)">${xjcyFigure()}</g></svg>`,
...
const REALM_OF_INTELLIGENCES: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 尝试沟通的困境", kickerEn: "II · The Trouble With Communicating", tagZh: "困境", tagEn: "The Trouble",
      art: `<svg viewBox="0 0 300 220">${ZNTWG_DEFS}<rect width="300" height="220" fill="#12102a"/>${zntwgGrid(8,.18)}${zntwgSwarm()}</svg>`,
    ...
    { kickerZh: "六 · 重新理解意识", kickerEn: "VI · Understanding Consciousness Anew", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${ZNTWG_DEFS}<rect width="300" height="220" fill="#12102a"/>${zntwgGrid(8,.2)}${zntwgSwarm()}</svg>`,
...
const XCZS_COVER = `<svg viewBox="0 0 300 220">${XCZS_DEFS}<rect width="300" height="220" fill="#150f28"/><circle cx="150" cy="80" r="40" fill="url(#xczsStar)"/>${xczsDust()}<g transform="translate(150,175) scale(0.5)">${xczsFigure()}</g></svg>`;
...
const BODY_OF_STARDUST: IllustratedEntry = {
  ...
  pages: [
    { kickerZh: "一 · 一堂意外的课", kickerEn: "I · An Unexpected Lesson", tagZh: "九炁星域 · 天文观测所", tagEn: "The Nine-Qi Domain \u00b7 The Astronomical Observatory",
      art: `<svg viewBox="0 0 300 220">${XCZS_DEFS}<rect width="300" height="220" fill="#150f28"/><circle cx="150" cy="80" r="35" fill="url(#xczsStar)"/><g transform="translate(150,175) scale(0.5)">${xczsFigure()}</g></svg>`,
    ...
    { kickerZh: "三 · 铁元素的旅程", kickerEn: "III · The Journey of Iron", tagZh: "具体说明", tagEn: "A Specific Example",
      art: `<svg viewBox="0 0 300 220">${XCZS_DEFS}<rect width="300" height="220" fill="#150f28"/><circle cx="150" cy="80" r="45" fill="url(#xczsStar)"><animate attributeName="r" values="35;55;35" dur="3s" repeatCount="indefinite"/></circle>${xczsDust()}</svg>`,
    ...
    { kickerZh: "五 · 关于原子归处的解答", kickerEn: "V · An Answer About Where Atoms Go", tagZh: "回到最初的问题", tagEn: "Returning to the Original Question",
      art: `<svg viewBox="0 0 300 220">${XCZS_DEFS}<rect width="300" height="220" fill="#150f28"/>${xczsWash([{x:150,y:100,rx:150,ry:70,color:'#ffd76a',op:.2}])}${xczsDust()}</svg>`,
    ...
    { kickerZh: "七 · 一份意外的宽慰", kickerEn: "VII · An Unexpected Comfort", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${XCZS_DEFS}<rect width="300" height="220" fill="#150f28"/>${xczsWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${xczsDust()}<g transform="translate(150,175) scale(0.65)">${xczsFigure()}</g></svg>`,
    ...
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "重新认识自己", tagEn: "Knowing Oneself Anew",
      art: `<svg viewBox="0 0 300 220">${XCZS_DEFS}<rect width="300" height="220" fill="#150f28"/><circle cx="150" cy="80" r="35" fill="url(#xczsStar)"/>${xczsDust()}<g transform="translate(150,175) scale(0.55)">${xczsFigure()}</g></svg>`,
...
const SXXL_COVER = `<svg viewBox="0 0 300 220">${SXXL_DEFS}<rect width="300" height="220" fill="#150f28"/>${sxxlGrid(8,.15)}${sxxlLoops()}<circle cx="150" cy="110" r="14" fill="url(#sxxlField)"/></svg>`;
...
const CHRONOLOGICAL_MIND: IllustratedEntry = {
  ...
  pages: [
    { kickerZh: "一 · 无法对齐的时间感", kickerEn: "I · A Sense of Time That Won't Align", tagZh: "龠光星", tagEn: "Yueguang Star",
      art: `<svg viewBox="0 0 300 220">${SXXL_DEFS}<rect width="300" height="220" fill="#150f28"/>${sxxlGrid(6,.15)}${sxxlLoops()}</svg>`,
    ...
    { kickerZh: "二 · 一次彻底的误会", kickerEn: "II · A Complete Misunderstanding", tagZh: "冲突", tagEn: "Conflict",
      art: `<svg viewBox="0 0 300 220">${SXXL_DEFS}<rect width="300" height="220" fill="#12102a"/>${sxxlGrid(8,.18)}${sxxlLoops()}</svg>`,
    ...
    { kickerZh: "三 · 请教这份差异", kickerEn: "III · Inquiring About the Difference", tagZh: "求解", tagEn: "Seeking Understanding",
      art: `<svg viewBox="0 0 300 220">${SXXL_DEFS}<rect width="300" height="220" fill="#150f28"/>${sxxlGrid(10,.2)}${sxxlLoops()}<circle cx="150" cy="110" r="18" fill="url(#sxxlField)"/></svg>`,
    ...
    { kickerZh: "四 · 尝试翻译彼此的语言", kickerEn: "IV · Trying to Translate Each Other", tagZh: "转折的契机", tagEn: "A Chance to Bridge the Gap",
      art: `<svg viewBox="0 0 300 220">${SXXL_DEFS}<rect width="300" height="220" fill="#12102a"/>${sxxlGrid(8,.2)}${sxxlLoops()}</svg>`,
    ...
    { kickerZh: "五 · 意外的互补", kickerEn: "V · An Unexpected Complementarity", tagZh: "发现", tagEn: "The Discovery",
      art: `<svg viewBox="0 0 300 220">${SXXL_DEFS}<rect width="300" height="220" fill="#150f28"/>${sxxlGrid(10,.22)}${sxxlLoops()}<circle cx="150" cy="110" r="24" fill="url(#sxxlField)"><animate attributeName="r" values="18;30;18" dur="3s" repeatCount="indefinite"/></circle></svg>`,
    ...
    { kickerZh: "七 · 一份持续的协作", kickerEn: "VII · An Ongoing Collaboration", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SXXL_DEFS}<rect width="300" height="220" fill="#150f28"/>${sxxlGrid(10,.2)}${sxxlLoops()}<circle cx="150" cy="110" r="28" fill="url(#sxxlField)"><animate attributeName="opacity" values=".5;.9;.5" dur="3s" repeatCount="indefinite"/></circle></svg>`,
    ...
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "多元时间感的共存", tagEn: "The Coexistence of Diverse Time-Senses",
      art: `<svg viewBox="0 0 300 220">${SXXL_DEFS}<rect width="300" height="220" fill="#150f28"/>${sxxlGrid(8,.18)}${sxxlLoops()}<circle cx="150" cy="110" r="16" fill="url(#sxxlField)"/></svg>`,
...
const LHGC_DEFS = `<defs><filter id="lhgcG"><feGaussianBlur stdDeviation="10"/></filter>
  <radialGradient id="lhgcField" cx="50%" cy="50%" r="60%"><stop offset="0%" stop-color="#fff6e8"/><stop offset="35%" stop-color="#c9a2ff"/><stop offset="100%" stop-color="#150f28" stop-opacity="0"/></radialGradient></defs>`;
...
const LHGC_COVER = `<svg viewBox="0 0 300 220">${LHGC_DEFS}<rect width="300" height="220" fill="#150f28"/><circle cx="150" cy="90" r="55" fill="url(#lhgcField)"/>${lhgcMotes()}<g transform="translate(150,175) scale(0.5)">${lhgcFigure()}</g></svg>`;
...
const WHERE_SOULS_RETURN: IllustratedEntry = {
  ...
  pages: [
    { kickerZh: "一 · 无法安放的疑问", kickerEn: "I · A Question With Nowhere to Rest", tagZh: "焕蜕星域 · 场域引路所", tagEn: "Huantui \u00b7 The Field Guidance House",
      art: `<svg viewBox="0 0 300 220">${LHGC_DEFS}<rect width="300" height="220" fill="#150f28"/>${lhgcMotes()}<g transform="translate(150,175) scale(0.55)">${lhgcFigure()}</g></svg>`,
    ...
    { kickerZh: "三 · 场域的传说", kickerEn: "III · The Field's Legend", tagZh: "讲述", tagEn: "The Telling",
      art: `<svg viewBox="0 0 300 220">${LHGC_DEFS}<rect width="300" height="220" fill="#150f28"/><circle cx="150" cy="90" r="60" fill="url(#lhgcField)"/>${lhgcMotes()}</svg>`,
    ...
    { kickerZh: "五 · 一次意外的相认", kickerEn: "V · An Unexpected Recognition", tagZh: "转折的契机", tagEn: "A Chance to Feel It", 
      art: `<svg viewBox="0 0 300 220">${LHGC_DEFS}<rect width="300" height="220" fill="#150f28"/><circle cx="150" cy="90" r="55" fill="url(#lhgcField)"/>${lhgcMotes()}<g transform="translate(150,175) scale(0.6)">${lhgcFigure()}</g></svg>`,
    ...
    { kickerZh: "七 · 重新理解失去", kickerEn: "VII · Understanding Loss Anew", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${LHGC_DEFS}<rect width="300" height="220" fill="#150f28"/><circle cx="150" cy="90" r="65" fill="url(#lhgcField)"/>${lhgcMotes()}<g transform="translate(150,175) scale(0.65)">${lhgcFigure()}</g></svg>`,
...
/* ---------- 删除旧地图：完整9页插画版 ---------- */
const DOM_COVER = `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwParticles()}<g stroke="#d8c07a" stroke-width=".8" opacity=".4" fill="none"><path d="M70 160 Q120 100 180 130 T230 90"/></g><g transform="translate(150,195) scale(0.45)">${rwFigure()}</g></svg>`;

const DELETING_OLD_MAP_ILLUSTRATED: IllustratedEntry = {
  slug: "deleting-the-old-map",
  title: "删除旧地图",
  titleEn: "Deleting the Old Map",
  cat: "rewrite",
  ...
  pages: [
    ...
    { kickerZh: "五 · 地图真正画的是什么", kickerEn: "V · What the Map Was Really Drawing", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwWash([{x:150,y:100,rx:180,ry:120,color:'#d8c07a',op:.3}])}<g transform="translate(150,195) scale(0.6)">${rwFigure()}</g></svg>`,
      textZh: "念棠，怔怔地，望着，那些，稚嫩的字迹，忽然，明白——这张地图，从头到尾，画的，从来，就不是，这座城市，真实的样子，是，当年，那个，格外害怕迷路、格外没有安全感的自己，把，内心的恐惧，投射，画成了，一整张，关于\u201c危险\u201d的地图。",
      textEn: "Staring at the childish handwriting, Nian Tang suddenly understood — this map had never truly depicted the city itself. It was the fear of her younger self, newly arrived and desperately insecure, projected and drawn into an entire map of \u201cdanger.\u201d" },
    { kickerZh: "六 · 郑重地删除旧地图", kickerEn: "VI · Solemnly Deleting the Old Map", tagZh: "行动", tagEn: "Taking Action",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="#0c1c14"/>${rwWash([{x:150,y:110,rx:170,ry:110,color:'#1c3830',op:.7}])}<g transform="translate(150,195) scale(0.6)">${rwFigure()}</g></svg>`,
      textZh: "念棠，郑重地，把，这张，用了十年的旧地图，收进了，一个，专门的盒子里，不再，把它，当成，出行的依据——她，决定，重新，用，此刻，这座城市，真实的样子，去，认识它，而，不是，继续，活在，十年前，那份，早已过时的恐惧里。",
      textEn: "Nian Tang solemnly placed the decade-old map into a special box, no longer treating it as a guide for travel — deciding to get to know the city as it truly was now, rather than continuing to live within a decade-old, outdated fear." },
    { kickerZh: "七 · 第一次走直路", kickerEn: "VII · Taking the Direct Road, at Last", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${rwParticles()}</svg>`,
      textZh: "第二天，念棠，第一次，鼓起勇气，走上了，那条，被，她，绕开了十年的\u201c危险\u201d路段——沿途，她，看见，热闹的店铺、悠闲散步的行人，一切，都，格外，寻常、格外，安全，与，记忆里，那份，模糊的恐惧，截然不同。",
      textEn: "The next day, Nian Tang gathered her courage and, for the first time, walked the \u201cdangerous\u201d stretch she'd detoured around for a decade — along the way, she saw bustling shops, leisurely strolling pedestrians, everything entirely ordinary, entirely safe, nothing like the vague fear in her memory." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "重新画一张地图", tagEn: "Drawing a New Map", 
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwParticles()}<g transform="translate(150,195) scale(0.45)">${rwFigure()}</g></svg>`,
      textZh: "念棠后来常说：\u201c我们，很多人，心里，都，藏着，一张，很多年前画的旧地图——不妨，偶尔，拿出来，看一看，那些，被标注着\u2018危险\u2019的地方，究竟，是，这个世界，真实的样子，还是，当年，那个，害怕的自己，投射出来的。\u201d",
      textEn: "Nian Tang often said afterward: \u201cMany of us carry an old map drawn years ago, deep inside — take it out now and then, and look: are the places marked \u2018dangerous\u2019 truly how the world is, or a projection of a once-frightened self?\u201d",
      closingZh: "那些被标注着危险的地方，究竟是这个世界真实的样子，还是当年那个害怕的自己投射出来的？",
      closingEn: "Are the places marked 'dangerous' truly how the world is, or a projection of a once-frightened self?" },
  ],
};

/* ---------- 我允许自己：完整9页插画版 ---------- */
const IAM_COVER = `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwParticles()}<circle cx="150" cy="105" r="34" fill="url(#rwGlow)"/><g transform="translate(150,195) scale(0.45)">${rwFigure()}</g></svg>`;

const I_ALLOW_MYSELF_ILLUSTRATED: IllustratedEntry = {
  slug: "i-allow-myself",
  title: "我允许自己",
  titleEn: "I Allow Myself",
  cat: "rewrite",
  ...
  pages: [
    ...
    { kickerZh: "五 · 终于说出口", kickerEn: "V · Finally Said Aloud", tagZh: "高潮的铺垫", tagEn: "Building to Climax",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwWash([{x:150,y:100,rx:150,ry:70,color:'#d8c07a',op:.25}])}<g transform="translate(150,195) scale(0.6)">${rwFigure()}</g></svg>`,
      textZh: "尝试了好几次，阮溪，终于，在，一个，格外脆弱的深夜，颤抖着，说出了，那句，完整的话：\u201c我，允许自己，犯错，允许自己，不够完美，允许自己，此刻，感到，脆弱。\u201d说完，她，泪流满面，却，感到，一种，说不清道不明的松动。",
      textEn: "After several attempts, on a particularly vulnerable night, Ruan Xi finally said the full line, trembling: \u201cI allow myself to make mistakes, allow myself to be imperfect, allow myself to feel vulnerable right now.\u201d Saying it, she wept, yet felt an unnameable loosening." },
    { kickerZh: "六 · 表面上什么都没变", kickerEn: "VI · Nothing Seemed to Change", tagZh: "转折", tagEn: "Turning Point",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="#0c1c14"/>${rwWash([{x:150,y:110,rx:170,ry:110,color:'#1c3830',op:.7}])}<g transform="translate(150,195) scale(0.6)">${rwFigure()}</g></svg>`,
      textZh: "那晚，说出这句话后，表面上，阮溪的生活，并没有，任何，立刻的改变——第二天，她，依然，要，照常，去，工作，依然，会，遇到，各种，需要，认真处理的问题。可，某种，说不清道不明的东西，已经，悄悄地，不一样了。",
      textEn: "That night, after saying the words, Ruan Xi's life didn't visibly change right away — the next day, she still went to work as usual, still faced various matters requiring careful handling. Yet something unnameable had quietly shifted." },
    { kickerZh: "七 · 渐渐显现的变化", kickerEn: "VII · Change Gradually Emerging", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${rwParticles()}</svg>`,
      textZh: "几个月后，阮溪，回头，细细，梳理，这段时间的变化，惊讶地，发现——自从，说出，那句\u201c我允许自己\u201d之后，自己，面对，失误时，不再，是，铺天盖地的自我攻击，而是，渐渐地，学会了，更加，温和、也，更加，高效地，去，解决问题。",
      textEn: "Months later, reflecting carefully on this period, Ruan Xi was surprised to find — since saying \u201cI allow myself,\u201d facing mistakes no longer triggered overwhelming self-attack, but instead, a gradually gentler, more effective way of solving problems." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "一切开始改变的那一天", tagEn: "The Day Everything Began to Change", 
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwParticles()}<g transform="translate(150,195) scale(0.45)">${rwFigure()}</g></svg>`,
      textZh: "阮溪后来，明白，那个，说出\u201c我允许自己\u201d的深夜，表面上，什么，都，没有，立刻，改变，可，那，正是，一切，开始，改变的，那一天——她后来常说：\u201c有些改变，从不会，在，说出口的那一刻，就，轰轰烈烈地，发生，它，只是，悄悄地，埋下了，一颗，种子。\u201d",
      textEn: "Ruan Xi later understood: the night she said \u201cI allow myself,\u201d nothing changed at once on the surface — but that was, in fact, the day everything began to change. She often said afterward: \u201cSome changes never happen dramatically, the moment they're spoken. They simply plant a seed, quietly.\u201d",
      closingZh: "有些改变，从不会在说出口的那一刻，就轰轰烈烈地发生，它只是，悄悄地，埋下了一颗种子。",
      closingEn: "Some changes never happen dramatically the moment they're spoken — they simply plant a seed, quietly." },
  ],
};

/* ---------- 从反应到回应：完整9页插画版 ---------- */
const RTR_COVER = `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwParticles()}<g transform="translate(150,195) scale(0.45)">${rwFigure()}</g></svg>`;

const REACTION_TO_RESPONSE_ILLUSTRATED: IllustratedEntry = {
  slug: "from-reaction-to-response",
  title: "从反应到回应",
  titleEn: "From Reaction to Response",
  cat: "rewrite",
  ...
  pages: [
    ...
    { kickerZh: "五 · 第一次成功的停顿", kickerEn: "V · The First Successful Pause", tagZh: "转折", tagEn: "Turning Point",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwWash([{x:150,y:100,rx:150,ry:70,color:'#d8c07a',op:.25}])}<g transform="translate(150,195) scale(0.6)">${rwFigure()}</g></svg>`,
      textZh: "几个月后的一次冲突里，顾行，第一次，成功地，在，脱口而出前，完成了，那三秒的停顿——那三秒里，他，清晰地，感受到，自己，原本，准备，说出口的，那句，尖锐的话，与，此刻，真正，想要，表达的、更加，平和的意思，之间，那份，巨大的差别。",
      textEn: "Months later, in a conflict, Gu Xing successfully completed the three-second pause for the first time before speaking — in those three seconds, he clearly felt the vast difference between the sharp words he'd been about to say and what he genuinely wanted to express, far gentler." },
    { kickerZh: "六 · 那三秒里的人", kickerEn: "VI · The Person Within Those Seconds", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="#0c1c14"/>${rwWash([{x:150,y:100,rx:180,ry:120,color:'#d8c07a',op:.3}])}<g transform="translate(150,195) scale(0.65)">${rwFigure()}</g></svg>`,
      textZh: "顾行，渐渐地，明白，那三秒的停顿里，站着的，从来，不是，一个，软弱、退让的自己，而是，一个，更加，从容、也，更加，清楚，自己，真正想要什么的、更好的自己——那，正是，他，一直，想要，成为，却，从未，真正，靠近过的样子。",
      textEn: "Gu Xing gradually understood that within those three seconds stood not a weak, yielding self, but a calmer, clearer, better version of himself who knew exactly what he truly wanted — precisely the self he'd always wanted to become, yet never truly approached." },
    { kickerZh: "七 · 越来越熟练的回应", kickerEn: "VII · An Increasingly Practiced Response", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${rwParticles()}</svg>`,
      textZh: "一年后，那份，三秒的停顿，渐渐地，成了，顾行，几乎，不假思索的本能。身边的朋友，都，明显地，感觉到，他，变得，更加，平和、也，更加，值得，信赖——那些，曾经，因为，脱口而出，而，受损的关系，也，渐渐地，修复了起来。",
      textEn: "A year later, the three-second pause had become nearly instinctive for Gu Xing. Friends noticed he'd grown noticeably calmer, more trustworthy — relationships once damaged by his blurted words gradually began to mend." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "三秒的重量", tagEn: "The Weight of Three Seconds", 
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwParticles()}<g transform="translate(150,195) scale(0.45)">${rwFigure()}</g></svg>`,
      textZh: "顾行后来常说：\u201c从反应到回应，中间，其实，只隔着，短短三秒，可，正是，这三秒，藏着，一个人，愿不愿意，成为，更好的自己的，全部答案。\u201d",
      textEn: "Gu Xing often said afterward: \u201cBetween reacting and responding lies only three short seconds — yet within those three seconds hides the entire answer to whether someone is willing to become a better version of themselves.\u201d",
      closingZh: "从反应到回应，中间只隔着短短三秒，可正是这三秒，藏着一个人愿不愿意成为更好的自己的全部答案。",
      closingEn: "Between reacting and responding lies only three seconds — yet within them hides the whole answer to whether we're willing to become better." },
  ],
};

/* ---------- 关掉警报的那一夜：完整9页插画版 ---------- */
const TOA_COVER = `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwParticles()}<circle cx="150" cy="100" r="20" fill="none" stroke="#d8c07a" stroke-width="1.2" opacity=".4"/><g transform="translate(150,195) scale(0.45)">${rwFigure()}</g></svg>`;

const TURNED_OFF_ALARM_ILLUSTRATED: IllustratedEntry = {
  slug: "the-night-i-turned-off-the-alarm",
  title: "关掉警报的那一夜",
  titleEn: "The Night I Turned Off the Alarm",
  cat: "rewrite",
  ...
  pages: [
    { kickerZh: "一 · 从不停歇的内在警报", kickerEn: "I · An Alarm That Never Stopped", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/><circle cx="150" cy="100" r="20" fill="none" stroke="#d8c07a" stroke-width="1.2" opacity=".5"/><g transform="translate(150,195) scale(0.5)">${rwFigure()}</g></svg>`,
    ...
    { kickerZh: "五 · 尝试关闭警报", kickerEn: "V · Trying to Turn It Off", tagZh: "行动", tagEn: "Taking Action",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwWash([{x:150,y:100,rx:150,ry:70,color:'#d8c07a',op:.25}])}<g transform="translate(150,195) scale(0.6)">${rwFigure()}</g></svg>`,
      textZh: "在，心理咨询师的引导下，念安，开始，练习着，每天，安静地，对，自己，内心，那份，警报，说：\u201c谢谢你，这么多年，一直，尽力地，保护着我，可，此刻，我，已经，安全了，你，可以，休息了。\u201d",
      textEn: "Under a counselor's guidance, Nian An began practicing, each day, quietly telling the alarm within her: \u201cThank you for trying so hard, all these years, to protect me. But I'm safe now — you can rest.\u201d" },
    { kickerZh: "六 · 真正关闭的那一夜", kickerEn: "VI · The Night It Finally Turned Off", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="#0c1c14"/>${rwWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,195) scale(0.65)">${rwFigure()}</g></svg>`,
      textZh: "几个月后的一个深夜，念安，忽然，清晰地，感到，那份，响了二十年的警报，第一次，真正地，安静了下来——那份，突如其来的、彻底的宁静，反而，让，她，感到，一种，格外陌生的、不知所措的失眠。",
      textEn: "Months later, one deep night, Nian An suddenly, clearly felt the twenty-year alarm truly fall silent for the first time — that sudden, complete stillness left her, strangely, unfamiliarly, unable to sleep." },
    { kickerZh: "七 · 不习惯的安静", kickerEn: "VII · An Unfamiliar Quiet", tagZh: "情感的核心", tagEn: "The Emotional Core",
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${rwParticles()}</svg>`,
      textZh: "那一夜，念安，躺在床上，久久，无法入睡——不是，因为，焦虑，而是，因为，这份，二十年来，第一次，真正，体验到的、彻底的安静，太过，陌生，她，甚至，一度，怀疑，是不是，哪里，出了问题。",
      textEn: "That night, Nian An lay awake for a long time — not out of anxiety, but because this complete quiet, experienced fully for the first time in twenty years, felt too unfamiliar. She even briefly wondered if something was wrong." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "重新学习安静", tagEn: "Relearning Stillness", 
      art: `<svg viewBox="0 0 300 220">${RW_DEFS}<rect width="300" height="220" fill="url(#rwSky)"/>${rwParticles()}<g transform="translate(150,195) scale(0.45)">${rwFigure()}</g></svg>`,
      textZh: "念安后来常说：\u201c关掉一份，响了很多年的警报，不会，立刻，带来，轻松，反而，会，带来，一种，格外陌生的不适——那份，不适，不是，退步，是，你的身心，正在，重新，学习，一件，早已，陌生了很久的事：真正的安静。\u201d",
      textEn: "Nian An often said afterward: \u201cTurning off an alarm that's rung for years doesn't bring instant ease — it brings an unusually unfamiliar discomfort instead. That discomfort isn't a setback. It's your body and mind relearning something long forgotten: true stillness.\u201d",
      closingZh: "关掉一份响了很多年的警报，不会立刻带来轻松，那份陌生的不适，是身心正在重新学习：真正的安静。",
      closingEn: "Turning off a long-ringing alarm doesn't bring instant ease. That unfamiliar discomfort is your body relearning true stillness." },
  ],
};
...
/* ---------- 雪线之外的寂静：远行者系列 IV，完整9页插画版 ---------- */
const WFSL_COVER = `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0a1420"/><g fill="#e8ecff" opacity=".8">${Array.from({length:20}).map(()=>{const x=Math.random()*300,y=Math.random()*140;return `<circle cx="${x}" cy="${y}" r=".8"/>`}).join('')}</g><path d="M0 180 L100 100 L180 150 L300 90 L300 220 L0 220 Z" fill="#c9d8f0" opacity=".7"/><g transform="translate(150,180) scale(0.4)">${wfFigure()}</g></svg>`;

const SNOWLINE_ILLUSTRATED: IllustratedEntry = {
  slug: "above-the-snowline",
  title: "雪线之外的寂静",
  titleEn: "Silence Beyond the Snowline · Wayfarer IV",
  cat: "field",
  ...
  pages: [
    { kickerZh: "一 · 向雪线攀登", kickerEn: "I · Climbing Toward the Snowline", tagZh: "焕蜕星域 · 远行者系列 IV", tagEn: "Huantui \u00b7 Wayfarer Series IV",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0e1826"/><path d="M0 190 L120 110 L200 160 L300 100 L300 220 L0 220 Z" fill="#3a4a60" opacity=".7"/><g transform="translate(150,180) scale(0.5)">${wfFigure()}</g></svg>`,
      textZh: "离开集市，沈行，一路，向着，一座，格外高耸的雪山，攀登。越，往上走，山下，那些，曾经，格外熟悉的、七嘴八舌的声音——家人的期待、旁人的评价、社会的规训——就，变得，越来越，微弱。",
      textEn: "Leaving the market, Shen Xing climbed steadily toward an especially towering snow-capped mountain. The higher he climbed, the fainter grew those once-familiar, clamoring voices below — family expectations, others' judgments, society's rules." },
    { kickerZh: "二 · 抵达雪线", kickerEn: "II · Reaching the Snowline", tagZh: "抵达", tagEn: "Arrival",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0a1420"/><g fill="#e8ecff" opacity=".8">${Array.from({length:16}).map(()=>{const x=Math.random()*300,y=Math.random()*140;return `<circle cx="${x}" cy="${y}" r=".8"/>`}).join('')}</g><path d="M0 180 L100 100 L180 150 L300 90 L300 220 L0 220 Z" fill="#c9d8f0" opacity=".7"/></svg>`,
      textZh: "终于，沈行，抵达了，雪线——那，是，山下，任何一种，替他，做决定的声音，都，无法，抵达的海拔。四周，只剩下，格外彻底的寂静，与，脚下，绵延不绝的皑皑白雪。",
      textEn: "Finally, Shen Xing reached the snowline — the altitude beyond which no voice deciding for him from below could reach. All around lay only a profound, total silence, and endless snow underfoot." },
    { kickerZh: "三 · 令人不安的寂静", kickerEn: "III · An Unsettling Silence", tagZh: "冲突", tagEn: "Conflict",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0a1420"/><path d="M0 190 L120 110 L200 160 L300 100 L300 220 L0 220 Z" fill="#c9d8f0" opacity=".6"/><g transform="translate(150,180) scale(0.55)">${wfFigure()}</g></svg>`,
      textZh: "让沈行，格外意外的是，这份，梦寐以求的寂静，并没有，带来，他，预想中的轻松，反而，让他，感到，一种，前所未有的、格外强烈的不安——多年来，他，早已，习惯了，依赖，那些，来自外界的声音，去，做，每一个决定，此刻，那些声音，全部，消失了，他，竟，一时，不知道，该，如何，独自，做出，任何选择。",
      textEn: "To his surprise, this long-dreamed-of silence didn't bring the ease he'd imagined — instead, an unprecedented, intense unease. For years, he'd relied on outside voices to make every decision; now that they'd all vanished, he suddenly didn't know how to choose anything on his own." },
    { kickerZh: "四 · 独自坐下", kickerEn: "IV · Sitting Down Alone", tagZh: "内心挣扎", tagEn: "Inner Struggle",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0e1826"/><path d="M0 190 L120 110 L200 160 L300 100 L300 220 L0 220 Z" fill="#3a4a60" opacity=".7"/><g transform="translate(150,180) scale(0.55)">${wfFigure()}</g></svg>`,
      textZh: "沈行，在，雪地上，独自，坐了下来，任由，这份，格外陌生的不安，持续着——他，第一次，意识到，自己，此前，从未，真正地，独自，面对过，任何一个，重大的抉择，总是，习惯性地，依靠，别人的声音，来，替，自己，分担，那份，选择的重量。",
      textEn: "Shen Xing sat alone in the snow, letting the unfamiliar unease continue — realizing, for the first time, he'd never truly faced any major decision entirely alone, always relying on others' voices to share the weight of choosing." },
    { kickerZh: "五 · 第一声真实的声音", kickerEn: "V · The First Genuine Voice", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0a1420"/><g fill="#e8ecff" opacity=".8">${Array.from({length:16}).map(()=>{const x=Math.random()*300,y=Math.random()*140;return `<circle cx="${x}" cy="${y}" r=".8"/>`}).join('')}</g><g transform="translate(150,180) scale(0.6)">${wfFigure()}</g></svg>`,
      textZh: "在，这份，彻底的寂静里，坐了，许久之后，沈行，忽然，第一次，清晰地，听见了，一个，此前，一直，被，外界的喧嚣，彻底，淹没的声音——那，是，他，自己，内心深处，真正的想法，第一次，不再，被，任何，外界的声音，干扰，清晰地，浮现了出来。",
      textEn: "After sitting a long while in that total silence, Shen Xing suddenly, clearly heard, for the first time, a voice previously drowned out entirely by outside noise — his own deepest, genuine thoughts, surfacing clearly, undisturbed by any external voice, for the first time." },
    { kickerZh: "六 · 独自做出的决定", kickerEn: "VI · A Decision Made Alone", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0e1826"/><path d="M0 190 L120 110 L200 160 L300 100 L300 220 L0 220 Z" fill="#3a4a60" opacity=".7"/><g transform="translate(150,180) scale(0.6)">${wfFigure()}</g></svg>`,
      textZh: "沈行，凭借，这份，第一次，真正，听见的、属于自己的声音，做出了，这趟旅程里，第一个，完全，不受，任何外界声音，影响的决定——那份，决定，或许，并不完美，却，前所未有地，真实，属于，他自己。",
      textEn: "Guided by this first truly heard, genuinely his own voice, Shen Xing made the journey's first decision entirely uninfluenced by any outside voice — perhaps imperfect, yet unprecedentedly real, and entirely his own." },
    { kickerZh: "七 · 带着这份声音下山", kickerEn: "VII · Descending With This Voice", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0a1420"/><path d="M0 180 L100 100 L180 150 L300 90 L300 220 L0 220 Z" fill="#c9d8f0" opacity=".7"/>${wfDust()}</svg>`,
      textZh: "沈行，带着，这份，第一次，真正，属于自己的声音，缓缓，下山——他，知道，回到，山下，那些，熟悉的喧嚣，很快，就会，重新，将他，包围，可，此刻，他，第一次，确信，自己，已经，拥有了，分辨，哪些声音，值得听、哪些声音，只是，噪音的能力。",
      textEn: "Shen Xing descended slowly, carrying this first genuinely his-own voice — knowing the familiar clamor below would soon surround him again, yet now, for the first time, confident he possessed the ability to tell which voices deserved listening to, and which were merely noise." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "旅程的第四课", tagEn: "The Journey's Fourth Lesson", 
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<g transform="translate(150,180) scale(0.5)">${wfFigure()}</g></svg>`,
      textZh: "沈行，在，笔记里，写道：\u201c旅程的第四课：偶尔，需要，主动，走到，一处，所有外界声音，都，到不了的海拔，才能，真正，听清，那个，一直，被，喧嚣，淹没着的、属于自己的声音。\u201d",
      textEn: "Shen Xing wrote in his journal: \u201cThe journey's fourth lesson: sometimes, one must deliberately climb to an altitude no outside voice can reach, to finally hear clearly the voice, long drowned in noise, that was always one's own.\u201d",
      closingZh: "过了雪线，山下所有替你做决定的声音，都到不了这个海拔，剩下的，只有你自己。",
      closingEn: "Past the snowline, none of the voices that decide for you can survive the altitude — what remains is only yourself." },
  ],
};

/* ---------- 敲钟人的分寸：远行者系列 V，完整9页插画版 ---------- */
const BT_COVER = `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<rect x="130" y="50" width="40" height="110" fill="none" stroke="#d8a24a" stroke-width="1.5" opacity=".5"/><circle cx="150" cy="90" r="16" fill="none" stroke="#d8a24a" stroke-width="1.2" opacity=".5"/><g transform="translate(150,195) scale(0.4)">${wfFigure()}</g></svg>`;

const BELL_TOWER_ILLUSTRATED: IllustratedEntry = {
  slug: "inside-the-bell-tower",
  title: "敲钟人的分寸",
  titleEn: "The Bell-Ringer's Restraint · Wayfarer V",
  cat: "field",
  ...
  pages: [
    { kickerZh: "一 · 山脚下的钟楼", kickerEn: "I · A Bell Tower at the Mountain's Foot", tagZh: "焕蜕星域 · 远行者系列 V", tagEn: "Huantui \u00b7 Wayfarer Series V",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/><rect x="130" y="50" width="40" height="110" fill="none" stroke="#d8a24a" stroke-width="1.5" opacity=".6"/><g transform="translate(150,195) scale(0.5)">${wfFigure()}</g></svg>`,
    ...
    { kickerZh: "三 · 令人困惑的说法", kickerEn: "III · A Puzzling Claim", tagZh: "困惑", tagEn: "Confusion",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:150,ry:70,color:'#d8a24a',op:.2}])}<g transform="translate(150,195) scale(0.55)">${wfFigure()}</g></svg>`,
    ...
    { kickerZh: "五 · 重新理解分寸", kickerEn: "V · Understanding Restraint Anew", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.25}])}<g transform="translate(150,195) scale(0.6)">${wfFigure()}</g></svg>`,
    ...
    { kickerZh: "七 · 沉默带来的尊重", kickerEn: "VII · The Respect Silence Earned", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${wfDust()}</svg>`,
      textZh: "让，沈行，格外意外的是，这份，克制的沉默，非但，没有，被，当成，软弱，反而，让，周围的人，对，他，多了，几分，格外的敬重——他们，感觉到，沈行，一旦，开口，说的，必定，是，经过，认真思考的话，而，不是，随口的情绪发泄。",
      textEn: "To Shen Xing's surprise, this restrained silence, far from being seen as weakness, earned him extra respect from those around him — they sensed that whenever he did speak, it would be carefully considered, not casual emotional venting." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "旅程的第五课", tagEn: "The Journey's Fifth Lesson", 
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<g transform="translate(150,195) scale(0.5)">${wfFigure()}</g></svg>`,
      textZh: "沈行，在，笔记里，写道：\u201c旅程的第五课：最难的功课，从来不是，敢于表达，是，分辨，什么时候，该，选择，克制的沉默——每一次开口，都是，在，动用，旁人对你的信任。\u201d",
      textEn: "Shen Xing wrote in his journal: \u201cThe journey's fifth lesson: the hardest task was never daring to speak — it's discerning when to choose restrained silence. Every word spoken draws on others' trust in you.\u201d",
      closingZh: "敲钟人最难的工作，从来不是敲钟，是分辨什么时候不该敲——每一次开口，都是在动用旁人对你的信任。",
      closingEn: "The bell-ringer's hardest task was never ringing the bell — it's knowing when not to. Every word spoken draws on others' trust." },
  ],
};

/* ---------- 河对岸的自己：远行者系列 VI，完整9页插画版 ---------- */
const RB_COVER = `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<rect x="0" y="150" width="300" height="8" fill="#4a5a7a" opacity=".5"/><g transform="translate(90,175) scale(0.4)">${wfFigure()}</g><g transform="translate(220,175) scale(0.4) scale(-1,1)">${wfFigure()}</g></svg>`;

const RIVER_BANKS_ILLUSTRATED: IllustratedEntry = {
  slug: "on-both-banks-of-the-river",
  title: "河对岸的自己",
  titleEn: "The Self on the Far Bank · Wayfarer VI",
  cat: "field",
  ...
  pages: [
    { kickerZh: "一 · 河边的身影", kickerEn: "I · A Figure by the River", tagZh: "焕蜕星域 · 远行者系列 VI", tagEn: "Huantui \u00b7 Wayfarer Series VI",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<rect x="0" y="150" width="300" height="8" fill="#4a5a7a" opacity=".5"/><g transform="translate(150,175) scale(0.5)">${wfFigure()}</g></svg>`,
    ...
    { kickerZh: "三 · 被留在原地的自己", kickerEn: "III · The Self Left Behind", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:150,ry:70,color:'#d8a24a',op:.2}])}<g transform="translate(220,175) scale(0.5) scale(-1,1)">${wfFigure()}</g></svg>`,
    ...
    { kickerZh: "七 · 决心不再回避", kickerEn: "VII · Resolving Not to Avoid Again", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${wfDust()}</svg>`,
      textZh: "沈行，望着，对岸，渐渐，远去的那些身影，郑重地，对自己，说：\u201c从今往后，每一次，面临，抉择，我，都，愿意，正视，那份，真实的恐惧，不再，让，更多的自己，被，留在，河的对岸。\u201d",
      textEn: "Watching those figures fade into the distance, Shen Xing solemnly told himself: \u201cFrom now on, whenever I face a choice, I'll be willing to face my genuine fear head-on, and not leave any more of myself behind on the far bank.\u201d" },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "旅程的第六课", tagEn: "The Journey's Sixth Lesson", 
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<g transform="translate(150,175) scale(0.5)">${wfFigure()}</g></svg>`,
      textZh: "沈行，在，笔记里，写道：\u201c旅程的第六课：每一次，选择\u2018安全\u2019的背后，都，留着，一个，被，放弃的自己——不必，因此，自责，只需要，记得，去，看见，那份，真实的代价。\u201d",
      textEn: "Shen Xing wrote in his journal: \u201cThe journey's sixth lesson: behind every choice of \u2018safe\u2019 lies an abandoned self — no need for self-blame, only to remember to see that real cost.\u201d",
      closingZh: "河对岸站着的那个身影，是你每一次选择「安全」时，被留在原地的另一个自己。",
      closingEn: "The figure on the far bank is every version of you left behind each time you chose 'safe.'" },
  ],
};

/* ---------- 暗夜市集不收钱：远行者系列 VII，完整9页插画版 ---------- */
const NM_COVER = `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0a0812"/>${wfDust()}<circle cx="120" cy="80" r="10" fill="url(#wfGlow)"/><circle cx="200" cy="100" r="8" fill="url(#wfGlow)"/><g transform="translate(150,185) scale(0.4)">${wfFigure()}</g></svg>`;

const NIGHT_MARKET_ILLUSTRATED: IllustratedEntry = {
  slug: "at-the-night-market",
  title: "暗夜市集不收钱",
  titleEn: "What the Night Market Takes Instead · Wayfarer VII",
  cat: "field",
  ...
  pages: [
    { kickerZh: "一 · 只在深夜出现的市集", kickerEn: "I · A Market That Only Appears at Night", tagZh: "焕蜕星域 · 远行者系列 VII", tagEn: "Huantui \u00b7 Wayfarer Series VII",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0a0812"/>${wfDust()}<g transform="translate(150,185) scale(0.5)">${wfFigure()}</g></svg>`,
      textZh: "沈行，一路，走到，一处，格外偏僻的村落，听，当地人，说起，一处，只在，最深的夜里，才会，出现的、神秘的市集。他，将信将疑，还是，决定，趁着，深夜，前去，一探究竟。",
      textEn: "Shen Xing arrived at a remote village, where locals spoke of a mysterious market appearing only in the deepest hours of night. Skeptical, he decided to venture out and see for himself." },
    { kickerZh: "二 · 不收钱的摊位", kickerEn: "II · Stalls That Take No Money", tagZh: "开场", tagEn: "The Encounter",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0e0a1a"}${wfWash([{x:150,y:110,rx:150,ry:90,color:'#1a1230',op:.7}])}<circle cx="120" cy="80" r="10" fill="url(#wfGlow)"/><circle cx="200" cy="100" r="8" fill="url(#wfGlow)"/></svg>`,
      textZh: "深夜，那处，格外奇特的市集，果然，出现了——摊位上，摆放的，不是，寻常的商品，每一个摊主，都，只，说着，同一句话：\u201c我们，不收钱，只收，你，觉得，自己，必须，一直，背着的重量。\u201d",
      textEn: "In the dead of night, this strange market indeed appeared — the stalls held no ordinary goods, and every vendor said the same line: \u201cWe take no money — only the weight you believe you have no choice but to carry.\u201d" },
    { kickerZh: "三 · 沈行的犹豫", kickerEn: "III · Shen Xing's Hesitation", tagZh: "内心挣扎", tagEn: "Inner Struggle",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:150,ry:70,color:'#d8a24a',op:.2}])}<g transform="translate(150,185) scale(0.55)">${wfFigure()}</g></svg>`,
      textZh: "沈行，站在，市集入口，犹豫了，许久——旅程至此，他，已经，放下了，不少，早该，松开的旧行李，可，心里，依然，藏着，一份，格外顽固、始终，没能，真正，放下的重量：那份，多年来，对，\u201c自己，必须，永远，坚强\u201d的、深深的执念。",
      textEn: "Shen Xing stood hesitating at the market's entrance — by this point in his journey, he'd already set down much of his outdated luggage, yet still carried one particularly stubborn weight he'd never truly released: a years-long, deep conviction that he must always be strong." },
    { kickerZh: "四 · 与摊主的对话", kickerEn: "IV · A Conversation With a Vendor", tagZh: "转折的契机", tagEn: "A Chance to See Differently",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0e0a1a"/>${wfWash([{x:150,y:110,rx:160,ry:100,color:'#1a1230',op:.75}])}<g transform="translate(105,185) scale(0.4)">${wfFigure()}</g><g transform="translate(195,185) scale(0.4)">${wfFigure()}</g></svg>`,
      textZh: "一位，摊主，看出，沈行的犹豫，温和地，问道：\u201c那份，你，始终，不愿，交出的重量，究竟，是什么？\u201d沈行，沉默了，许久，才，艰难地，说出口：\u201c是，我，必须，永远，坚强，不能，在任何人面前，露出，脆弱的这份，执念。\u201d",
      textEn: "A vendor, sensing his hesitation, asked gently: \u201cThat weight you still won't hand over — what is it?\u201d After a long silence, Shen Xing finally, with difficulty, said: \u201cThe conviction that I must always be strong, never showing weakness before anyone.\u201d" },
    { kickerZh: "五 · 交出重量", kickerEn: "V · Handing Over the Weight", tagZh: "高潮的铺垫", tagEn: "Building to Climax",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.25}])}<g transform="translate(150,185) scale(0.6)">${wfFigure()}</g></svg>`,
      textZh: "在，摊主的，温和引导下，沈行，第一次，郑重地，把，这份，深藏了多年的执念，完整地，说了出来——包括，那些，他，从未，向任何人，坦白过的、脆弱的时刻，与，深深的恐惧。",
      textEn: "Under the vendor's gentle guidance, Shen Xing, for the first time, solemnly voiced this years-buried conviction in full — including moments of vulnerability and deep fear he'd never confessed to anyone." },
    { kickerZh: "六 · 意外的轻盈", kickerEn: "VI · Unexpected Lightness", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="#0e0a1a"/>${wfWash([{x:150,y:110,rx:170,ry:110,color:'#1a1230',op:.7}])}<g transform="translate(150,185) scale(0.65)">${wfFigure()}</g></svg>`,
      textZh: "说完，那份，长期，压着他的重量，第一次，真正地，被，交了出去——沈行，感到，一种，前所未有的、彻底的轻盈，那份，长期，绷紧着的、\u201c必须坚强\u201d的姿态，第一次，得以，真正地，松弛下来。",
      textEn: "Having spoken it fully, the long-carried weight was, for the first time, genuinely handed over — Shen Xing felt an unprecedented, complete lightness, the long-tensed posture of \u201cmust be strong\u201d finally allowed to truly relax." },
    { kickerZh: "七 · 市集消失前的最后一句话", kickerEn: "VII · One Last Line Before the Market Vanished", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${wfDust()}</svg>`,
      textZh: "天，渐渐，泛白，那处，神秘的市集，也，缓缓，开始，消散。临走前，那位，摊主，留下了，最后一句话：\u201c脆弱，从来，不是，需要，被，藏起来的弱点，是，一份，同样，值得，被，好好，看见的，真实。\u201d",
      textEn: "As dawn broke, the mysterious market began slowly to fade. Before vanishing, the vendor left one final line: \u201cVulnerability was never a flaw to hide — it's a truth equally deserving of being truly seen.\u201d" },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "旅程的第七课", tagEn: "The Journey's Seventh Lesson", 
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<g transform="translate(150,185) scale(0.5)">${wfFigure()}</g></svg>`,
      textZh: "沈行，在，笔记里，写道：\u201c旅程的第七课：有些重量，从不需要，被，独自，背负一辈子，只需要，找到，一个，愿意，认真倾听的地方，好好地，交出去。\u201d",
      textEn: "Shen Xing wrote in his journal: \u201cThe journey's seventh lesson: some weight was never meant to be carried alone for a lifetime — it only needs a place willing to truly listen, to be properly handed over.\u201d",
      closingZh: "暗夜市集不收钱，只收你以为自己必须一直背着的重量——脆弱，从来不是需要被藏起来的弱点。",
      closingEn: "The night market takes no money — only the weight you believed you had no choice but to carry. Vulnerability was never a flaw to hide." },
  ],
};

/* ---------- 远行者与镜中人：远行者系列终篇 VIII，完整9页插画版 ---------- */
const TM_COVER = `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${wfDust()}<g transform="translate(105,185) scale(0.4)">${wfFigure()}</g><g transform="translate(195,185) scale(0.4)">${wfFigure()}</g></svg>`;

const TRAVELER_MIRROR_SELF_ILLUSTRATED: IllustratedEntry = {
  slug: "the-traveler-and-the-mirror-self",
  title: "远行者与镜中人",
  titleEn: "The Traveler and the Mirror Self · Wayfarer VIII",
  cat: "field",
  ...
  pages: [
    ...
    { kickerZh: "三 · 一个奇怪的共同点", kickerEn: "III · A Strange Commonality", tagZh: "发现的开端", tagEn: "The Beginning of a Discovery",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:150,ry:70,color:'#d8a24a',op:.2}])}<g transform="translate(150,185) scale(0.6)">${wfFigure()}</g></svg>`,
    ...
    { kickerZh: "五 · 终极的顿悟", kickerEn: "V · The Ultimate Realization", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,185) scale(0.65)">${wfFigure()}</g></svg>`,
    ...
    { kickerZh: "七 · 旅程真正的意义", kickerEn: "VII · The Journey's True Meaning", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${wfDust()}</svg>`,
      textZh: "沈行，终于，明白，这趟，漫长的旅程，真正的意义，从来，不是，去，寻找，某个，外在的、能够，替他，解决一切困惑的答案，是，一路上，借由，一个个，不同的相遇，一点一点，重新，认回，那个，本就，完整、本就，拥有，全部智慧的、真实的自己。",
      textEn: "Shen Xing finally understood: this long journey's true meaning was never seeking some external answer to resolve every confusion — it was, through a series of different encounters, gradually recognizing again the true self, already whole, already possessing all the wisdom needed." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "远行者系列 · 终章", tagEn: "The Wayfarer Series · Final Chapter", 
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<g transform="translate(150,185) scale(0.5)">${wfFigure()}</g></svg>`,
      textZh: "沈行，在，旅程笔记的最后一页，写下：\u201c一路上，教你东西的每一个人，其实，都是，同一个人——那，就是，你自己，本就，拥有，却，一直，忘了，认出的智慧。旅程，从不是，为了，抵达，某个，外在的终点，是，为了，认回，自己。\u201d",
      textEn: "On the final page of his travel journal, Shen Xing wrote: \u201cEvery teacher along the road was, in truth, the same person — the wisdom you've always had, but simply forgot to recognize. The journey was never about reaching some external destination — it was about recognizing yourself.\u201d",
      closingZh: "一路上教你东西的每一个人，其实都是同一个人——那就是你自己，本就拥有、却一直忘了认出的智慧。",
      closingEn: "Every teacher along the road was, in truth, the same person — the wisdom you've always had, but simply forgot to recognize." },
  ],
};

/* ---------- 互联的清晨：完整9页插画版 ---------- */
const IC_COVER = `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<g stroke="#d8a24a" stroke-width=".6" opacity=".4"><path d="M60 100 Q150 60 240 130"/><path d="M90 150 Q150 110 210 160"/></g><g transform="translate(90,175) scale(0.4)">${wfFigure()}</g><g transform="translate(210,175) scale(0.4)">${wfFigure()}</g></svg>`;

const INTERCONNECTION_MORNING_ILLUSTRATED: IllustratedEntry = {
  slug: "a-morning-of-interconnection",
  title: "互联的清晨",
  titleEn: "A Morning of Interconnection",
  cat: "field",
  ...
  pages: [
    ...
    { kickerZh: "三 · 传递给邻居的温暖", kickerEn: "III · Passed to a Neighbor", tagZh: "第一次传递", tagEn: "The First Ripple",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:150,ry:70,color:'#d8a24a',op:.2}])}<g transform="translate(105,175) scale(0.4)">${wfFigure()}</g><g transform="translate(195,175) scale(0.4)">${wfFigure()}</g></svg>`,
    ...
    { kickerZh: "五 · 无法追溯的源头", kickerEn: "V · An Untraceable Origin", tagZh: "场域视角", tagEn: "The Field's Perspective",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/><g stroke="#d8a24a" stroke-width=".6" opacity=".5"><path d="M60 100 Q150 60 240 130"/><path d="M90 150 Q150 110 210 160"/><path d="M40 170 Q120 140 200 190"/></g>${wfDust()}</svg>`,
    ...
    { kickerZh: "七 · 阮季浑然不知", kickerEn: "VII · Ruan Ji, Unaware", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}<g transform="translate(150,175) scale(0.5)">${wfFigure()}</g></svg>`,
      textZh: "而，那份，善意，最初的起点——阮季，此刻，正，坐在，办公室里，专心地，处理着，手头的工作，完全，不会知道，那个，清晨，随手，系紧的一个绳结，此刻，正，以，怎样的方式，继续，在，这个世界上，悄然，流转。",
      textEn: "And at the very origin of that kindness — Ruan Ji, right now, sat in her office, focused on her work, having no idea how the string she'd casually tied that morning was, at this very moment, continuing to quietly circulate through the world." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "场里的善意", tagEn: "Kindness Within the Field", 
      art: `<svg viewBox="0 0 300 220">${WF_DEFS}<rect width="300" height="220" fill="url(#wfSky)"/>${wfDust()}<g transform="translate(90,175) scale(0.4)">${wfFigure()}</g><g transform="translate(210,175) scale(0.4)">${wfFigure()}</g></svg>`,
      textZh: "这，正是，场，最温柔的秘密之一：每一份，看似微不足道的善意，从不会，真正地，停留在，它最初发生的地方，会，借由，场，持续地，传递下去，抵达，无数个，我们，自己，永远，都不会知道的地方。",
      textEn: "This is one of the Field's gentlest secrets: every seemingly small act of kindness never truly stays where it began — it continues, carried by the Field, reaching countless places we ourselves will never know.",
      closingZh: "一个人善待陌生人的清晨，那份善意，在场里传了很远——远到，他自己，都不会知道。",
      closingEn: "One morning, a person chooses kindness to a stranger. That kindness travels through the Field farther than he'll ever know." },
  ],
};
...
const SOV_DEFS = `<defs><filter id="sovG"><feGaussianBlur stdDeviation="9"/></filter>
  ...
  <linearGradient id="sovSky" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1330"/><stop offset="50%" stop-color="#241a38"/><stop offset="100%" stop-color="#5a4478"/></linearGradient></defs>`;
...
function sovFigure(){const robe=`<path d="M-11 -32 Q0 -37 11 -32 L14 24 Q0 30 -14 24 Z" fill="#241a38"/>`;const head=`<circle cx="0" cy="-38" r="7" fill="#1e1638"/>`;return `<g><animateTransform attributeName="transform" type="translate" values="0 0;0 -3;0 0" dur="4s" repeatCount="indefinite"/>${robe}${head}</g>`;}
...
const OBSERVERS_NOTES_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 第一个观察对象", kickerEn: "II · The First Subject", tagZh: "开场", tagEn: "The Beginning",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,180) scale(0.55)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "四 · 记录下的困惑", kickerEn: "IV · A Puzzled Record", tagZh: "困惑", tagEn: "Confusion",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,180) scale(0.6)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "六 · 重新理解观察者的责任", kickerEn: "VI · Understanding the Observer's Duty Anew", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#a68fc9',op:.3}])}<g transform="translate(150,180) scale(0.6)">${sovFigure()}</g></svg>`,
...
const COORDINATES_FEAR_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 一直被绕开的区域", kickerEn: "II · A Territory Always Avoided", tagZh: "背景", tagEn: "Context",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,195) scale(0.55)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "四 · 令人震动的重新理解", kickerEn: "IV · A Startling Reframing", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g stroke="#a68fc9" stroke-width=".8" opacity=".5" fill="none"><rect x="60" y="60" width="180" height="110"/></g></svg>`,
    ...
    { kickerZh: "六 · 抵达那个坐标", kickerEn: "VI · Arriving at the Coordinate", tagZh: "转折", tagEn: "Turning Point",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,195) scale(0.6)">${sovFigure()}</g></svg>`,
...
const SOVEREIGNS_SILENCE_ILLUSTRATED: IllustratedEntry = {
  ...
  pages: [
    ...
    { kickerZh: "二 · 一场格外重要的会议", kickerEn: "II · An Especially Important Session", tagZh: "背景", tagEn: "Context",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(105,180) scale(0.4)">${sovFigure()}</g><g transform="translate(195,180) scale(0.4)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "四 · 同僚的疑问", kickerEn: "IV · A Colleague's Question", tagZh: "冲突", tagEn: "Conflict",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(105,180) scale(0.4)">${sovFigure()}</g><g transform="translate(195,180) scale(0.4)">${sovFigure()}</g></svg>`,
    ...
    { kickerZh: "六 · 沉默的重新定义", kickerEn: "VI · Redefining Silence", tagZh: "高潮的铺垫", tagEn: "Building to Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,180) scale(0.6)">${sovFigure()}</g></svg>`,
...
/* ---------- 从场观察愤怒：完整9页插画版 ---------- */
const WAF_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<circle cx="150" cy="90" r="26" fill="#e85a3a" opacity=".3"><animate attributeName="r" values="20;30;20" dur="2.5s" repeatCount="indefinite"/></circle><g transform="translate(150,180) scale(0.5)">${sovFigure()}</g></svg>`;

const WATCHING_ANGER_ILLUSTRATED: IllustratedEntry = {
  slug: "watching-anger-from-the-field",
  title: "从场观察愤怒",
  titleEn: "Watching Anger from the Field",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 火爆的脾气", kickerEn: "I · A Fiery Temper", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,180) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "顾行，年轻时，脾气，格外火爆，几乎，人人，都，习惯性地，躲着他——一点，微不足道的小事，都，可能，让他，勃然大怒，那份，来得，格外迅猛的怒火，让，身边的人，都，感到，格外，难以，靠近。",
      textEn: "In his youth, Gu Xing had a fiery temper; nearly everyone kept their distance out of habit — the smallest thing could send him into a rage, that swift-arriving fury making him unusually hard to approach." },
    { kickerZh: "二 · 被孤立的处境", kickerEn: "II · Growing Isolated", tagZh: "困扰的加深", tagEn: "The Trouble Deepens",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,180) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "这份，令人畏惧的怒火，渐渐地，让，顾行，在，人际关系里，变得，格外孤立——朋友，一个接一个，疏远了他，可，顾行，始终，不明白，自己，为什么，总是，这么，容易，生气。",
      textEn: "This intimidating fury gradually left Gu Xing increasingly isolated in his relationships — friends drifted away, one after another, yet Gu Xing never understood why he was always so quick to anger." },
    { kickerZh: "三 · 一位前辈的点破", kickerEn: "III · An Elder's Insight", tagZh: "转折的契机", tagEn: "A Chance to See Differently",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(105,180) scale(0.4)">${sovFigure()}</g><g transform="translate(195,180) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一位，前辈，点破了，这一点：\u201c你，不是，天生，易怒，是，太，习惯，把，自己的边界，一忍再忍，忍到，最后，只能，用，最激烈的方式，才能，把，那句，早该，说出口的\u2018不可以\u2019，喊出来。\u201d",
      textEn: "A mentor pointed something out: \u201cYou weren't born quick to anger. You simply grew too accustomed to swallowing your own boundaries, again and again, until the only way left to voice a long-overdue \u2018no\u2019 was through an outburst.\u201d" },
    { kickerZh: "四 · 回想每一次爆发", kickerEn: "IV · Recalling Every Outburst", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,180) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "顾行，试着，回想，每一次，自己，勃然大怒的场景——果然，每一次，背后，都，藏着，一句，他，一直，没能，及时，说出口的、简单的拒绝，只是，他，从未，真正，留意过，这份，规律。",
      textEn: "Gu Xing tried recalling every time he'd erupted — and sure enough, behind each one lay a simple refusal he'd never managed to say in time. He'd simply never noticed the pattern before." },
    { kickerZh: "五 · 重新理解愤怒", kickerEn: "V · Understanding Anger Anew", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#a68fc9',op:.3}])}<g transform="translate(150,180) scale(0.65)">${sovFigure()}</g></svg>`,
      textZh: "顾行，忽然，明白——从，场的角度看，愤怒，从来，不是，破坏性的力量，是，一份，被，延迟太久的、边界声明——如果，他，能，更早地，把，那份，不满，清楚地，说出口，或许，就，不需要，等到，忍无可忍，才，用，最激烈的方式，爆发出来。",
      textEn: "Gu Xing suddenly understood — seen from the Field, anger was never a destructive force at all, but a boundary statement delayed too long. If he'd voiced his displeasure clearly, sooner, perhaps he wouldn't need to wait until unbearable, erupting so intensely." },
    { kickerZh: "六 · 开始练习及时表达", kickerEn: "VI · Practicing Timely Expression", tagZh: "行动", tagEn: "Taking Action",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,180) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "顾行，开始，练习，在，委屈，刚刚升起的那一刻，就，把，边界，清楚地，说出来，不再，等到，忍无可忍——第一次，尝试，这样做时，他，甚至，紧张得，声音，都，有些，颤抖。",
      textEn: "Gu Xing began practicing stating his boundaries clearly the moment grievance first arose, no longer waiting until he could bear it no more — the first time he tried, his voice even trembled slightly with nerves." },
    { kickerZh: "七 · 越来越罕见的怒火", kickerEn: "VII · Fury Growing Rare", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${sovStars()}</svg>`,
      textZh: "渐渐地，那份，曾经，让，身边人，都，害怕的怒火，变得，越来越，罕见——朋友们，也，渐渐地，重新，靠近了他，惊讶于，那个，曾经，火爆易怒的顾行，此刻，竟，变得，格外，平和、格外，容易，相处。",
      textEn: "Gradually, the fury that once frightened those around him grew rarer and rarer — friends gradually drew close again, surprised that the once-volatile Gu Xing had become remarkably calm, remarkably easy to be around." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "边界声明", tagEn: "A Boundary Statement", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,180) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "顾行后来常说：\u201c愤怒，从场的角度看，从不是，破坏性的力量，是，一份，被，延迟太久的，边界声明——学会，及时，说出\u2018不可以\u2019，比，忍到，最后，爆发出来，要，温柔得多。\u201d",
      textEn: "Gu Xing often said afterward: \u201cSeen from the Field, anger isn't destructive — it's a boundary statement delivered far too late. Learning to say \u2018no\u2019 in time is far gentler than holding on until you erupt.\u201d",
      closingZh: "愤怒从场的角度看，不是一种破坏性的力量，是一份被延迟太久的边界声明。",
      closingEn: "Seen from the Field, anger isn't destructive — it's a boundary statement delivered far too late." },
  ],
};

/* ---------- 意志的几何：完整9页插画版 ---------- */
const GOW_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g stroke="#a68fc9" stroke-width="1" opacity=".5" fill="none"><path d="M150 190 Q100 170 110 140 Q120 110 150 105 Q180 100 185 75 Q190 50 160 40"/></g><g transform="translate(150,195) scale(0.4)">${sovFigure()}</g></svg>`;

const GEOMETRY_WILL_ILLUSTRATED: IllustratedEntry = {
  slug: "the-geometry-of-will",
  title: "意志的几何",
  titleEn: "The Geometry of Will",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 反反复复的意志力", kickerEn: "I · Wavering Willpower", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,195) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念溪，总，为，自己，反反复复的意志力，感到，格外沮丧——她，下定决心，要，养成的习惯，总是，坚持，没几天，就，退回了，原点，仿佛，所有的努力，都，白费了。",
      textEn: "Nian Xi was constantly discouraged by her own wavering willpower — every habit she resolved to build would collapse within days, back to square one, as if all her effort had been wasted." },
    { kickerZh: "二 · 一次又一次的自我怀疑", kickerEn: "II · Repeated Self-Doubt", tagZh: "困扰的加深", tagEn: "The Trouble Deepens",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,195) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "每一次，退步，都，让，念溪，更加，怀疑，自己的意志力，是不是，天生，就，格外薄弱——这份，反复的自我怀疑，渐渐地，让，她，越来越，不敢，轻易，再，尝试，任何，新的改变。",
      textEn: "Every setback left Nian Xi doubting more whether her willpower was inherently weak — this repeated self-doubt gradually made her more and more reluctant to attempt any new change at all." },
    { kickerZh: "三 · 一位朋友的比喻", kickerEn: "III · A Friend's Metaphor", tagZh: "转折的契机", tagEn: "A Chance to Reconsider",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(105,195) scale(0.4)">${sovFigure()}</g><g transform="translate(195,195) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一位，年长的朋友，告诉她，一个，完全不同的看法：\u201c你，以为，意志，是一条，笔直向前的线，所以，每一次，退步，都，让，你，觉得，回到了原点。可，意志，从来，不是，直线，是，一种，螺旋——你，此刻，站着的位置，看起来，和，上一次退步时，几乎一样，可，你，其实，已经，往上，爬升了，另外一整圈。\u201d",
      textEn: "An older friend offered a completely different view: \u201cYou think will is a straight line moving forward, so every setback feels like returning to where you started. But will was never a line — it's a spiral. The point where you're standing now may look almost identical to where you fell last time, but you've actually climbed one full loop higher.\u201d" },
    { kickerZh: "四 · 半信半疑", kickerEn: "IV · Skeptical, Yet Intrigued", tagZh: "内心挣扎", tagEn: "Inner Doubt",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,195) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "念溪，将信将疑，回家后，回头，细细，比对了，自己，每一次\u201c退步\u201d时的状态——她，翻出，过去的日记，仔细，对比，每一次，坚持的天数、每一次，跌落时的心境。",
      textEn: "Skeptical, Nian Xi went home and carefully compared her state each time she'd \u201cfallen\u201d — digging out old journals, closely comparing how many days she'd sustained each attempt, her state of mind each time she'd fallen." },
    { kickerZh: "五 · 意外的发现", kickerEn: "V · An Unexpected Discovery", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.25}])}<g stroke="#a68fc9" stroke-width="1" opacity=".5" fill="none"><path d="M150 190 Q100 170 110 140 Q120 110 150 105 Q180 100 185 75"/></g></svg>`,
      textZh: "果然，这一次的退步，比上一次，坚持得，更久，跌落得，也，更轻——她，惊讶地，发现，这份，反复，并非，一场，毫无意义的循环，而是，一段，缓慢却，真实的爬升，只是，她，此前，从未，用，这个角度，去，看待过，它。",
      textEn: "Indeed, this latest setback had lasted longer, and the fall had been gentler — she was surprised to find this wasn't a meaningless cycle at all, but a slow, real climb, one she'd simply never viewed from this angle before." },
    { kickerZh: "六 · 重新绘制自己的曲线", kickerEn: "VI · Redrawing Her Own Curve", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g stroke="#a68fc9" stroke-width="1" opacity=".5" fill="none"><path d="M150 190 Q100 170 110 140 Q120 110 150 105 Q180 100 185 75 Q190 50 160 40"/></g></svg>`,
      textZh: "念溪，开始，用，螺旋的方式，重新，记录，自己的每一次尝试——不再，只是，简单地，标注\u201c成功\u201d或\u201c失败\u201d，而是，认真地，记录下，每一圈，比，上一圈，多，爬升了，多少。",
      textEn: "Nian Xi began recording each attempt as a spiral, no longer simply marking \u201csuccess\u201d or \u201cfailure,\u201d but earnestly noting how much higher each loop had climbed compared to the last." },
    { kickerZh: "七 · 更加从容的坚持", kickerEn: "VII · A Calmer Persistence", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${sovStars()}</svg>`,
      textZh: "这份，全新的视角，让，念溪，面对，每一次，新的\u201c退步\u201d时，都，多了，一份，格外，从容的耐心——她，不再，因为，一次，跌落，就，彻底，否定，自己，而是，平静地，相信，自己，正，走在，那条，缓慢却，真实的螺旋上升的路上。",
      textEn: "This new perspective gave Nian Xi an unusually calm patience with every new \u201csetback\u201d — no longer entirely dismissing herself over a single fall, but calmly trusting she was walking a slow, real, spiraling upward path." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "螺旋上升", tagEn: "Spiraling Upward", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,195) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念溪，终于，明白，意志的几何，从不是，一条，笔直的线，是一种，螺旋——每一次，看似的后退，都是，在，爬升，另一圈。",
      textEn: "Nian Xi finally understood: will was never a straight line — it's a spiral. Every apparent step back is a climb along another loop.",
      closingZh: "意志不是一条直线，是一种螺旋——每一次看似的后退，都是在爬升另一圈。",
      closingEn: "Will isn't a straight line — it's a spiral. Every apparent step back is a climb along another loop." },
  ],
};

/* ---------- 一个不服从的粒子：完整9页插画版 ---------- */
const DP_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#150f28"/><g stroke="#a68fc9" stroke-width=".6" opacity=".4" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g><circle cx="150" cy="60" r="4" fill="#fff6e8"><animate attributeName="opacity" values=".4;1;.4" dur="2s" repeatCount="indefinite"/></circle></svg>`;

const DISOBEDIENT_PARTICLE_ILLUSTRATED: IllustratedEntry = {
  slug: "a-disobedient-particle",
  title: "一个不服从的粒子",
  titleEn: "A Disobedient Particle",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 一份被归档的观测误差", kickerEn: "I · A Filed-Away Observational Error", tagZh: "龠光星", tagEn: "Yueguang Star",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#150f28"/><g stroke="#a68fc9" stroke-width=".6" opacity=".4" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g></svg>`,
      textZh: "析衡，在，整理，一批，陈旧的物理观测记录时，发现，一条，被，归档的记录：那颗粒子，在，某个瞬间，忽然，拒绝，按照，已知的物理规律，运动——仪器，反复检测，都，无法，找出，任何，能，解释，这份，异常的原因，最终，只能，把它，归档为\u201c未解的观测误差\u201d。",
      textEn: "Sorting through old physics observation records, Xiheng found one filed away: at a certain instant, that particle suddenly refused to move according to known physical law — repeated instrument checks found no explanation for the anomaly, and it was finally filed away as \u201cunresolved observational error.\u201d" },
    { kickerZh: "二 · 一份格外的好奇", kickerEn: "II · A Particular Curiosity", tagZh: "困惑", tagEn: "Curiosity",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#12102a"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}</svg>`,
      textZh: "析衡，对，这份，被，草草归档的记录，产生了，一份，格外的好奇——如果，这份，异常，真的，只是，仪器误差，为什么，此后，再也，没有，出现过，第二次，类似的、可以，被，明确归因为\u201c误差\u201d的记录？",
      textEn: "Xiheng felt particular curiosity about this hastily filed record — if the anomaly was truly just instrument error, why had no similar record, clearly attributable to \u201cerror,\u201d ever appeared again since?" },
    { kickerZh: "三 · 重新调阅原始数据", kickerEn: "III · Reviewing the Raw Data", tagZh: "求解", tagEn: "Seeking Understanding",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#150f28"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g stroke="#a68fc9" stroke-width=".6" opacity=".5" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g></svg>`,
      textZh: "析衡，调阅，那次观测，最原始的数据，逐一，比对——那颗粒子，在，异常发生的瞬间，展现出的，运动轨迹，格外，特殊，不是，随机的紊乱，是，一种，格外，规整、格外，带有，某种，方向性的偏离。",
      textEn: "Xiheng pulled the most raw data from that observation, comparing it point by point — the particle's trajectory at the moment of anomaly was unusually specific, not random chaos, but a strikingly regular, directional deviation." },
    { kickerZh: "四 · 场的视角", kickerEn: "IV · The Field's Perspective", tagZh: "转折的契机", tagEn: "A Chance to See Differently",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#12102a"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<circle cx="150" cy="60" r="4" fill="#fff6e8"><animate attributeName="opacity" values=".4;1;.4" dur="2s" repeatCount="indefinite"/></circle></svg>`,
      textZh: "析衡，尝试，从，场的视角，而，非，纯粹的物理学视角，重新，审视，这份，异常——从，场的角度看，这，不是，一次，需要，被，修正的错误，是，一次，觉醒的瞬间：一颗，原本，只会，机械遵循规律的粒子，在，那个瞬间，第一次，展现出了，某种，超越了，纯粹被动服从的、微弱却真实的、自主性。",
      textEn: "Xiheng tried reexamining this anomaly from the Field's perspective, rather than a purely physical one — from the Field's view, this wasn't an error needing correction, but a moment of awakening: a particle that had only ever mechanically obeyed the rules, in that instant, showed something beyond mere passive compliance for the first time — faint, yet real, autonomy." },
    { kickerZh: "五 · 物理学与场，两种称呼", kickerEn: "V · Two Names, Physics and the Field", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#150f28"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g stroke="#a68fc9" stroke-width=".6" opacity=".5" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g></svg>`,
      textZh: "析衡，在，记录里，郑重地，写下：\u201c物理学，称之为，异常。场，称之为，觉醒。\u201d同一份数据，因为，看待它的视角不同，得出的，结论，竟，如此，截然不同——这份，发现，本身，让，析衡，感到，一种，格外，深刻的震撼。",
      textEn: "Xiheng wrote solemnly in the record: \u201cPhysics calls it an anomaly. The Field calls it an awakening.\u201d The same data, viewed from different perspectives, yielded such starkly different conclusions — this discovery itself left Xiheng profoundly moved." },
    { kickerZh: "六 · 重新审视更多的\u201c误差\u201d", kickerEn: "VI · Reexamining More 'Errors'", tagZh: "行动", tagEn: "Taking Action",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#12102a"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g stroke="#a68fc9" stroke-width=".6" opacity=".5" fill="none">${Array.from({length:5}).map((_,i)=>`<circle cx="${60+i*45}" cy="150" r="10"/>`).join('')}</g></svg>`,
      textZh: "析衡，开始，系统地，重新，调阅，更多，被，同样，草率地，归档为\u201c误差\u201d的观测记录——这一次，带着，全新的视角，他，从中，找到了，好几起，同样，具有，明确方向性的、格外特殊的偏离。",
      textEn: "Xiheng began systematically reviewing more observations similarly hastily filed as \u201cerror\u201d — this time, with a new perspective, finding several more instances of similarly specific, directionally deliberate deviation." },
    { kickerZh: "七 · 一份全新的研究方向", kickerEn: "VII · A New Research Direction", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#150f28"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${sovStars()}</svg>`,
      textZh: "析衡，把，这份，发现，提交给了，更广泛的研究团队，提议，建立，一套，全新的、不再，简单地，把，规律之外的偏离，草率归档为\u201c误差\u201d的观测标准——这份提议，最终，开启了，一整套，全新的、关于\u201c微观自主性\u201d的研究方向。",
      textEn: "Xiheng submitted this discovery to a broader research team, proposing a new observational standard that no longer hastily filed deviations from known laws as mere \u201cerror\u201d — this proposal ultimately opened an entirely new research direction into \u201cmicroscopic autonomy.\u201d" },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "值得被重新看一眼的偏离", tagEn: "A Deviation Worth a Second Look", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#150f28"/>${sovStars()}<g stroke="#a68fc9" stroke-width=".6" opacity=".4" fill="none">${Array.from({length:4}).map((_,i)=>`<circle cx="150" cy="110" r="${20+i*16}"/>`).join('')}</g></svg>`,
      textZh: "析衡，后来，在，一次公开讲座上，说道：\u201c或许，这世上，所有，看似\u2018不合常理\u2019的偏离，都，值得，被，重新看一眼——它，究竟，是一次，需要被修正的错误，还是，一次，正在发生的、觉醒的瞬间。\u201d",
      textEn: "Xiheng later said at a public lecture: \u201cPerhaps every seemingly \u2018irrational\u2019 deviation in this world deserves a second look — is it truly an error needing correction, or a moment of awakening, already underway.\u201d",
      closingZh: "一颗粒子拒绝按规律运动的那一刻，物理学称之为异常，场称之为觉醒。",
      closingEn: "The instant a particle refuses to move by the rules, physics calls it an anomaly. The Field calls it an awakening." },
  ],
};

/* ---------- 内在议会：完整9页插画版 ---------- */
const IP_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(90,180) scale(0.35)">${sovFigure()}</g><g transform="translate(150,180) scale(0.35)">${sovFigure()}</g><g transform="translate(210,180) scale(0.35)">${sovFigure()}</g></svg>`;

const INNER_PARLIAMENT_ILLUSTRATED: IllustratedEntry = {
  slug: "the-inner-parliament",
  title: "内在议会",
  titleEn: "The Inner Parliament",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 永不停歇的内在会议", kickerEn: "I · A Session That Never Adjourns", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,180) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念季，年轻时，常常，被，心里，那场，永不停息的内在会议，搅得，心力交瘁——每一个，决定，做出之前，心里，总，同时，响起，好几种，截然不同、各执一词的声音，让，她，格外，难以，真正，做出选择。",
      textEn: "In her youth, Nian Ji was often exhausted by the endless session within her — before every decision, several conflicting voices would rise at once, each insisting on its own view, leaving her unable to truly choose." },
    { kickerZh: "二 · 三个熟悉的代表", kickerEn: "II · Three Familiar Delegates", tagZh: "背景", tagEn: "Context",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(90,180) scale(0.35)">${sovFigure()}</g><g transform="translate(150,180) scale(0.35)">${sovFigure()}</g><g transform="translate(210,180) scale(0.35)">${sovFigure()}</g></svg>`,
      textZh: "念季，渐渐，能够，分辨出，那，几种，反复出现的声音——恐惧党，总，在，提醒着，各种，可能的危险；习惯党，坚持，一切，都该，照旧有的方式，进行；渴望党，则，不断，鼓动着，去，追求，那些，还未实现的、新的可能。",
      textEn: "Nian Ji gradually learned to distinguish these recurring voices — the Fear Party, forever warning of every possible danger; the Habit Party, insisting everything proceed exactly as before; the Longing Party, endlessly pushing toward new, yet-unrealized possibilities." },
    { kickerZh: "三 · 任由某一党占据上风", kickerEn: "III · Letting One Party Take Over", tagZh: "困扰的加深", tagEn: "The Trouble Deepens",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(150,180) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "过去，念季，总是，任由，某一党，暂时，占据上风，做出决定，事后，又，被，另一党，翻出来，反复，质问、后悔——今天，被恐惧党，说服，放弃了机会；明天，又，被渴望党，鼓动，做出，冲动的决定。",
      textEn: "In the past, Nian Ji always let whichever party momentarily gained the upper hand make the decision, only to have another party dredge it up later, questioning, regretting — one day persuaded by Fear to give up an opportunity, the next swayed by Longing into an impulsive choice." },
    { kickerZh: "四 · 一位智者的比喻", kickerEn: "IV · A Wise Elder's Metaphor", tagZh: "转折的契机", tagEn: "A Chance to Reconsider",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(105,180) scale(0.4)">${sovFigure()}</g><g transform="translate(195,180) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一位，智者，告诉，念季：\u201c主权，从不是，让，某一党，永远获胜，也不是，强行，让，所有党，安静下来，是，学会，主持，这场会议——认真，听，每一党，把话说完，再，综合，各方，做出，一个，真正属于\u2018你自己\u2019的决定，而不是，任由，某一党，替你，做主。\u201d",
      textEn: "A wise elder told her: \u201cSovereignty was never letting one party win forever, nor forcing all parties silent. It's learning to chair the session — listening earnestly to each party's full case, then integrating them into a decision that's truly \u2018yours,\u2019 rather than letting any single party decide for you.\u201d" },
    { kickerZh: "五 · 第一次尝试主持", kickerEn: "V · The First Attempt to Chair", tagZh: "行动", tagEn: "Taking Action",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.25}])}<g transform="translate(150,180) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "念季，面对，一次，格外重要的抉择，第一次，尝试，安静地，扮演起，那位，居中，主持会议的角色——她，逐一，认真地，听，恐惧党、习惯党、渴望党，各自，把，理由，完整地，说完，不再，急着，让，任何一方，抢先，做主。",
      textEn: "Facing an especially important decision, Nian Ji, for the first time, tried quietly playing the role of the presiding chair — earnestly listening to Fear, Habit, and Longing each state their full case in turn, no longer rushing to let any one party decide first." },
    { kickerZh: "六 · 一个真正属于自己的决定", kickerEn: "VI · A Decision Truly Her Own", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,180) scale(0.65)">${sovFigure()}</g></svg>`,
      textZh: "听完，所有的声音后，念季，第一次，做出了，一个，综合了，各方考量、却，不完全，等同于，任何一党意见的、真正属于\u201c她自己\u201d的决定——那份，决定，格外，踏实，不再，带着，事后，反复，翻悔的不安。",
      textEn: "Having heard every voice, Nian Ji, for the first time, made a decision integrating every consideration, yet not fully identical to any single party's view — a decision truly her own, unusually grounded, no longer carrying the unease of later regret." },
    { kickerZh: "七 · 渐渐容易听懂的争吵", kickerEn: "VII · Arguments Growing Easier to Hear", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${sovStars()}</svg>`,
      textZh: "念季，开始，练习，在，每一次，内心争执时，安静地，扮演起，那位，居中，主持会议的角色。渐渐地，那些，曾经，让，她，心力交瘁的争吵，变得，越来越，容易，被，好好听懂、好好安放。",
      textEn: "Nian Ji began practicing, in every inner conflict, quietly playing the presiding chair. Gradually, the arguments that once exhausted her became easier and easier to hear out, and lay to rest." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "学会主持", tagEn: "Learning to Chair", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(90,180) scale(0.35)">${sovFigure()}</g><g transform="translate(150,180) scale(0.35)">${sovFigure()}</g><g transform="translate(210,180) scale(0.35)">${sovFigure()}</g></svg>`,
      textZh: "念季，后来，常说：\u201c每个人，心里，都，坐着，一群，各执一词的代表——主权，不是，消灭，这场会议，是，学会，好好，主持，它。\u201d",
      textEn: "Nian Ji often said afterward: \u201cEveryone hosts a parliament within, each with their own view — sovereignty isn't eliminating this session, it's learning to chair it well.\u201d",
      closingZh: "每个人心里都坐着一群各执一词的代表——主权，是学会主持这场会议。",
      closingEn: "Everyone hosts a parliament within — Fear, Habit, Longing. Sovereignty is learning to chair the session." },
  ],
};

/* ---------- 主权体与镜像人格：完整9页插画版 ---------- */
const SMP_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<rect x="120" y="70" width="60" height="90" rx="4" fill="none" stroke="#a68fc9" stroke-width="1.5" opacity=".5"/><g transform="translate(150,195) scale(0.4)">${sovFigure()}</g></svg>`;

const MIRROR_PERSONALITY_ILLUSTRATED: IllustratedEntry = {
  slug: "the-sovereign-and-the-mirror-personality",
  title: "主权体与镜像人格",
  titleEn: "The Sovereign and the Mirror Personality",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 两个割裂的自己", kickerEn: "I · Two Selves, Divided", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,195) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念舟，一直，觉得，自己，在外人面前，展现出的那个，永远，从容、得体的角色，是，一种，虚假的伪装，与，私下里，那个，脆弱、纠结的自己，是，完全，割裂的两个人。",
      textEn: "Nian Zhou had always felt that the composed, appropriate role she showed the world was a false mask, entirely severed from the fragile, tangled self she was in private." },
    { kickerZh: "二 · 疲于扮演的疲惫", kickerEn: "II · The Exhaustion of Performing", tagZh: "困扰的加深", tagEn: "The Trouble Deepens",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,195) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "这份，长期的割裂感，让，念舟，感到，格外，疲惫——每一次，在外人面前，维持着，那份，从容的形象，都，像是，在，进行，一场，格外，费力的表演，回到，私下里，她，总要，花上，好一阵，才能，真正，卸下，这份，疲惫。",
      textEn: "This long-standing sense of division left Nian Zhou deeply exhausted — every time she maintained her composed image before others felt like an effortful performance, and alone afterward, she'd need a long while to truly set down the fatigue." },
    { kickerZh: "三 · 与挚友的坦白", kickerEn: "III · Confiding in a Close Friend", tagZh: "求解", tagEn: "Seeking Understanding",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(105,195) scale(0.4)">${sovFigure()}</g><g transform="translate(195,195) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一次，念舟，向，一位，挚友，坦白了，这份，长期的疲惫。挚友，听完，却，给出了，一个，完全不同的视角：\u201c你，以为，那个，得体的角色，是假的，可，她，做出的每一个选择、说出的每一句话，其实，都，源自，你自己，真实的价值观。\u201d",
      textEn: "Confiding this long-held exhaustion to a close friend, Nian Zhou received an entirely different view: \u201cYou think that composed role is fake, but every choice she makes, every word she speaks, actually springs from your own genuine values.\u201d" },
    { kickerZh: "四 · 令人震动的重新理解", kickerEn: "IV · A Startling Reframing", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<rect x="120" y="70" width="60" height="90" rx="4" fill="none" stroke="#a68fc9" stroke-width="1.5" opacity=".6"/></svg>`,
      textZh: "挚友，继续，说道：\u201c她，不是，一个，虚假的伪装，是，你自己，一个，同样真实的分身，只是，她，演得太投入，久而久之，忘了，自己，其实，一直，在演。\u201d念舟，愣住了，第一次，重新，审视，那个，一贯从容的自己。",
      textEn: "The friend continued: \u201cShe isn't a false disguise, she's an equally real facet of yourself. She's simply performed it so wholeheartedly, for so long, she forgot she was performing at all.\u201d Nian Zhou froze, reexamining, for the first time, that consistently composed self." },
    { kickerZh: "五 · 重新审视从容", kickerEn: "V · Reexamining Composure", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.25}])}<g transform="translate(150,195) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "念舟，发现，那份从容，并非，凭空捏造，是，自己，真心，相信的、待人接物的方式，只是，渐渐地，忘了，给，私下里，那个，同样真实的、脆弱的自己，留一点，喘息的空间。",
      textEn: "Nian Zhou realized that composure hadn't been fabricated from nothing. It was a way of engaging with others she genuinely believed in — only she'd gradually forgotten to leave any breathing room for the equally real, fragile self in private." },
    { kickerZh: "六 · 尝试整合两个自己", kickerEn: "VI · Trying to Integrate Both Selves", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,195) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "念舟，开始，练习着，在，维持，从容形象的同时，也，允许，自己，偶尔，在，信任的人面前，展现，那份，同样真实的脆弱——不再，把，这两个自己，当成，需要，彻底割裂的对立面。",
      textEn: "Nian Zhou began practicing — while maintaining her composed image, also allowing herself, before trusted people, to occasionally show the equally real fragility, no longer treating these two selves as opposites needing complete separation." },
    { kickerZh: "七 · 不再疲惫的从容", kickerEn: "VII · A Composure No Longer Exhausting", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${sovStars()}</svg>`,
      textZh: "渐渐地，那份，曾经，让，念舟，格外疲惫的\u201c表演感\u201d，明显地，减轻了——她，依然，在外人面前，展现出，从容的一面，可，这份从容，不再，是，需要，费力维持的伪装，是，她，自己，真实的一部分。",
      textEn: "Gradually, the once-exhausting sense of \u201cperformance\u201d noticeably eased — Nian Zhou still showed a composed side to others, but this composure was no longer an effortfully maintained disguise; it was a genuine part of herself." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "演得太投入的分身", tagEn: "A Facet That Performed Too Wholeheartedly", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,195) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念舟后来常说：\u201c你，在别人面前，扮演的那个角色，其实，也是，主权体的一种分身——只是，她，演得太投入，忘了，自己，在演。\u201d",
      textEn: "Nian Zhou often said afterward: \u201cThe role you play for others is also a facet of the sovereign self — only she's performed it so wholeheartedly, she forgot she was performing.\u201d",
      closingZh: "你在别人面前扮演的那个角色，其实也是主权体的一种分身——只是它演得太投入，忘了自己在演。",
      closingEn: "The role you play for others is also a facet of the sovereign self — one that performed it so wholeheartedly, it forgot it was performing." },
  ],
};

/* ---------- 自由意志的重量：完整9页插画版 ---------- */
const WFW_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,180) scale(0.5)">${sovFigure()}</g></svg>`;

const WEIGHT_FREE_WILL_ILLUSTRATED: IllustratedEntry = {
  slug: "the-weight-of-free-will",
  title: "自由意志的重量",
  titleEn: "The Weight of Free Will",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 对自由的无比渴望", kickerEn: "I · A Deep Longing for Freedom", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,180) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "顾行，年轻时，无比，渴望，真正的自由意志——渴望，能够，完全，自主地，决定，自己的人生，不再，受，任何人的安排、任何环境的裹挟，那份，对自由的向往，几乎，成了，他，最重要的人生目标。",
      textEn: "In his youth, Gu Xing longed, more than anything, for true free will — to fully, autonomously decide the course of his own life, no longer bound by anyone's arrangements, no longer swept along by circumstance. That longing for freedom became, almost, his most important life goal." },
    { kickerZh: "二 · 终于拥有的自由", kickerEn: "II · Freedom Finally Attained", tagZh: "背景", tagEn: "Context",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,180) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "多年以后，顾行，终于，凭借，自己的努力，真正，拥有了，这份，梦寐以求的自由——他，可以，完全，自主地，决定，自己人生的，每一个重大方向，不再，受，任何外界的，束缚。",
      textEn: "Years later, through his own effort, Gu Xing finally attained this long-dreamed-of freedom — able to fully, autonomously decide every major direction of his own life, no longer bound by any external constraint." },
    { kickerZh: "三 · 意外的沉重感", kickerEn: "III · An Unexpected Heaviness", tagZh: "困惑", tagEn: "Confusion",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(150,180) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "可，让，顾行，格外意外的是，真正，拥有，这份自由后，他，却，第一次，感到，一种，前所未有的、沉重的压力——每一个，选择，做出之后，再也，没有，任何人，可以，被，拿来，怪罪。",
      textEn: "But to his great surprise, having finally attained this freedom, Gu Xing felt, for the first time, an unprecedented, crushing pressure — for every choice made, there was no longer anyone left to blame." },
    { kickerZh: "四 · 全部责任的重量", kickerEn: "IV · The Weight of Total Responsibility", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,180) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "顾行，开始，深刻地，感受到——成功，是，自己应得的；失败，也，同样，只能，由自己，一个人，承担。这份，全部，由自己，独自，承担的重量，比，他，此前，想象中的，要，沉重得多。",
      textEn: "Gu Xing began to feel, profoundly — success was rightfully his own; failure, too, was his alone to bear. This weight of total, solitary responsibility proved far heavier than he'd ever imagined." },
    { kickerZh: "五 · 寻找当年的前辈", kickerEn: "V · Seeking the Old Mentor", tagZh: "求解", tagEn: "Seeking Understanding",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.25}])}<g transform="translate(105,180) scale(0.4)">${sovFigure()}</g><g transform="translate(195,180) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "顾行，找到，当年，那位，曾经，鼓励，他，追求自由的前辈，坦言了，这份，沉重的困惑。前辈，只是，平静地，笑了笑：\u201c你，终于，摸到了，自由意志，最沉重的部分——它，从来，不是，选择本身，是，选择之后，那份，再，无处，可以推卸的、完整的责任。\u201d",
      textEn: "Gu Xing sought out the mentor who'd once encouraged him to pursue freedom, confessing this heavy confusion. The mentor only smiled, calmly: \u201cYou've finally touched the heaviest part of free will — it was never the choosing itself. It's that afterward, there's a whole, undivided responsibility left with nowhere else to go.\u201d" },
    { kickerZh: "六 · 重新理解自由", kickerEn: "VI · Understanding Freedom Anew", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,180) scale(0.65)">${sovFigure()}</g></svg>`,
      textZh: "顾行，忽然，明白——他，此前，一直，只，向往，自由，光鲜、令人振奋的那一面，从未，真正，准备好，去，承接，自由，背后，同样，真实存在的、沉重的责任。真正的自由，从不是，轻盈的，是，需要，与，这份，重量，共处的。",
      textEn: "Gu Xing suddenly understood — he'd only ever longed for freedom's glamorous, exhilarating side, never truly prepared to bear the equally real, heavy responsibility behind it. True freedom was never light — it required coexisting with this weight." },
    { kickerZh: "七 · 学会与重量共处", kickerEn: "VII · Learning to Coexist With the Weight", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${sovStars()}</svg>`,
      textZh: "顾行，不再，试图，逃避，这份，沉重的责任感，而是，学着，与它，好好共处——每一次，面临，重大抉择，他，都，会，郑重地，提醒自己：这份重量，正是，自由本身，不可分割的一部分。",
      textEn: "Gu Xing stopped trying to escape this heavy sense of responsibility, learning instead to coexist with it well — before every major decision, solemnly reminding himself: this weight was an inseparable part of freedom itself." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "自由最沉重的部分", tagEn: "The Heaviest Part of Freedom", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,180) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "顾行后来常说：\u201c自由意志，最沉重的部分，从来不是，选择本身，是，选择之后，不再，有人，可以，被，怪罪——这份，重量，不是，自由的代价，是，自由的一部分。\u201d",
      textEn: "Gu Xing often said afterward: \u201cThe heaviest part of free will was never the choosing — it's that afterward, there's no one left to blame. This weight isn't the cost of freedom — it's part of freedom itself.\u201d",
      closingZh: "自由意志最沉重的部分，从来不是选择本身，是选择之后，不再有人可以被怪罪。",
      closingEn: "The heaviest part of free will was never the choosing — it's that afterward, there's no one left to blame." },
  ],
};

/* ---------- 观测者效应·人类版：完整9页插画版 ---------- */
const OE_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<circle cx="150" cy="100" r="24" fill="#e8dcff" opacity=".3"><animate attributeName="r" values="18;28;18" dur="2.5s" repeatCount="indefinite"/></circle><g transform="translate(150,185) scale(0.45)">${sovFigure()}</g></svg>`;

const OBSERVER_EFFECT_ILLUSTRATED: IllustratedEntry = {
  slug: "the-observer-effect-human-edition",
  title: "观测者效应 · 人类版",
  titleEn: "The Observer Effect, Human Edition",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 习惯性的压抑", kickerEn: "I · Habitual Suppression", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念安，习惯了，一感到，情绪波动，就，立刻，用理智，把它，压下去——无论，是，格外强烈的沮丧，还是，说不清道不明的烦躁，她，总是，第一时间，选择，视而不见，继续，照常，处理，手头的事。",
      textEn: "Nian An had always, the moment she felt an emotion stir, immediately reasoned it away — whether intense frustration or unnameable restlessness, she'd instinctively look past it, carrying on with whatever was at hand." },
    { kickerZh: "二 · 压抑积累的代价", kickerEn: "II · The Cost of Accumulated Suppression", tagZh: "困扰的加深", tagEn: "The Trouble Deepens",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "这份，长期的压抑，渐渐地，让，念安，感到，一种，说不清道不明的、持续的紧绷感——那些，被，压下去的情绪，从未，真正，消失，只是，累积在，心里，某个，她，自己，都，说不清的角落。",
      textEn: "This prolonged suppression gradually left Nian An with an unnameable, persistent tension — the emotions pushed down never truly vanished, only accumulating somewhere within, in a corner even she couldn't quite locate." },
    { kickerZh: "三 · 一次静心练习", kickerEn: "III · A Meditation Practice", tagZh: "转折的契机", tagEn: "A Chance to Try Differently",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一次，静心练习里，一位老师，让，她，尝试，反过来做：不去，压抑，情绪，只是，安静地，观察它。念安，将信将疑，试着，把，注意力，放在，胸口那阵，说不清道不明的烦躁上。",
      textEn: "In a meditation practice, a teacher had her try the opposite: not suppressing the feeling, but simply, quietly, observing it. Skeptical, Nian An tried placing her attention on the unnameable restlessness in her chest." },
    { kickerZh: "四 · 意外的变化", kickerEn: "IV · An Unexpected Shift", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<circle cx="150" cy="100" r="24" fill="#e8dcff" opacity=".35"><animate attributeName="r" values="18;28;18" dur="2.5s" repeatCount="indefinite"/></circle></svg>`,
      textZh: "奇怪的是，就在，她，开始，专注地，观察，这份情绪的，那一刻，那份烦躁，本身，竟，悄悄地，起了变化，不再，那么，尖锐、灼人，反而，渐渐地，松动、软化了下来。",
      textEn: "Strangely, the instant she began observing it closely, the restlessness itself quietly shifted — no longer so sharp, so scalding, gradually loosening, softening instead." },
    { kickerZh: "五 · 老师的解释", kickerEn: "V · The Teacher's Explanation", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "老师，解释道：\u201c你观察自己情绪的那一刻，情绪本身，就，已经，改变了——这，不是，什么，深奥的量子力学，是，每天，都在，发生的事。观察，从不是，中立、不介入的行为，观察本身，就是，一种，温柔的、正在，参与其中的，介入。\u201d",
      textEn: "The teacher explained: \u201cThe moment you observe your own emotion, the emotion itself has already changed — this isn't some profound quantum mechanics, it's something happening every single day. Observation was never a neutral, uninvolved act — observation itself is a gentle intervention, already taking part.\u201d" },
    { kickerZh: "六 · 开始练习观察", kickerEn: "VI · Beginning to Practice Observing", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "念安，开始，练习着，每一次，感到，情绪波动，不再，立刻，压抑，而是，先，安静地，观察它——看看，这份情绪，究竟，从何而来，又，会，如何，随着，这份，温柔的关注，慢慢，变化。",
      textEn: "Nian An began practicing — whenever emotion stirred, no longer immediately suppressing it, but first quietly observing it, watching where it came from, how it gradually shifted under this gentle attention." },
    { kickerZh: "七 · 情绪不再堆积", kickerEn: "VII · Emotions No Longer Piling Up", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${sovStars()}</svg>`,
      textZh: "几个月后，念安，明显地，感到，那份，长期的紧绷感，渐渐地，消散了——情绪，不再，被，压抑、堆积，而是，在，被，观察的那一刻，就，开始，自然地，流动、化解，不再，累积成，说不清道不明的负担。",
      textEn: "Months later, Nian An noticeably felt the long-held tension gradually dissolve — emotions no longer suppressed, piling up, but beginning to naturally flow and resolve the moment they were observed, no longer accumulating into an unnameable burden." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "每天都在发生的事", tagEn: "Something Happening Every Day", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念安后来常说：\u201c你观察自己情绪的那一刻，情绪本身，就已经，改变了——这不是量子力学，这是，每天，都在发生的事。\u201d",
      textEn: "Nian An often said afterward: \u201cThe moment you observe your own emotion, the emotion changes — not quantum physics, just an everyday fact.\u201d",
      closingZh: "你观察自己情绪的那一刻，情绪本身就已经改变了——这不是量子力学，这是每天都在发生的事。",
      closingEn: "The moment you observe your own emotion, the emotion changes — not quantum physics, just an everyday fact." },
  ],
};

/* ---------- 与恐惧对坐：完整9页插画版 ---------- */
const SAF_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`;

const SITTING_FEAR_ILLUSTRATED: IllustratedEntry = {
  slug: "sitting-across-from-fear",
  title: "与恐惧对坐",
  titleEn: "Sitting Across from Fear",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 反复出现的恐惧", kickerEn: "I · A Recurring Fear", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "阮衡，这些年，一直，试图，彻底，消灭，心里，那份，反复出现的恐惧——每次，恐惧，浮现，他，都会，立刻，用尽全力，把它，压下去、赶走，可，那份恐惧，却，总是，过不了多久，又，卷土重来。",
      textEn: "For years, Ruan Heng had tried to entirely eliminate the fear that kept resurfacing in his mind — each time it appeared, he'd force it down, chase it away with everything he had, only for it to return, again and again, before long." },
    { kickerZh: "二 · 消灭策略的失败", kickerEn: "II · A Failed Strategy of Elimination", tagZh: "困扰的加深", tagEn: "The Trouble Deepens",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "阮衡，试过，各种，消灭这份恐惧的方法——转移注意力、强行说服自己\u201c没什么好怕的\u201d，可，这份，恐惧，却，格外，顽固，每一次，被，暂时，压制下去，都会，在，某个，格外脆弱的时刻，重新，浮现。",
      textEn: "Ruan Heng tried every method to eliminate this fear — distraction, forcing himself to believe there was nothing to fear — yet it proved stubborn, resurfacing at some especially vulnerable moment, every time it was temporarily suppressed." },
    { kickerZh: "三 · 一位场域引导者的建议", kickerEn: "III · A Field Guide's Suggestion", tagZh: "转折的契机", tagEn: "A Chance to Try Differently",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一位，场域引导者，告诉他，一个，完全不同的方法：\u201c场，从不建议，消灭恐惧，只建议，给它，倒一杯茶，然后，问它：你，究竟，在，替我，守着什么？\u201d",
      textEn: "A Field guide offered him an entirely different method: \u201cThe Field never suggests eliminating fear — only pouring it tea, then asking: what, exactly, have you been guarding for me?\u201d" },
    { kickerZh: "四 · 将信将疑的尝试", kickerEn: "IV · A Skeptical Attempt", tagZh: "行动的开端", tagEn: "The Start of a Practice",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "阮衡，将信将疑，第一次，没有，急着，赶走，那份，熟悉的恐惧，而是，安静地，坐下来，仿佛，真的，给它，倒了一杯茶，然后，认真地，问了，那个问题。",
      textEn: "Skeptical, Ruan Heng, for the first time, didn't rush to chase away the familiar fear, but sat quietly instead, as if genuinely pouring it a cup of tea, and earnestly asked that question." },
    { kickerZh: "五 · 恐惧背后的答案", kickerEn: "V · The Answer Behind the Fear", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "他，第一次，清晰地，听见，那份恐惧，背后，藏着的答案——那不是，一份，需要，被消灭的敌意，是，多年前，一次，受过伤的经历，留下的、一份，笨拙却，真心的守护。",
      textEn: "For the first time, he heard clearly the answer hidden behind that fear — not some hostility needing elimination, but a clumsy, sincere act of guarding, left behind by an old wound from years before." },
    { kickerZh: "六 · 重新理解这份守护", kickerEn: "VI · Understanding This Guardianship Anew", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "阮衡，第一次，郑重地，向，这份，一直，被，他，视为敌人的恐惧，道了谢——他，开始，明白，这份，笨拙的守护，虽然，方式，令人，不适，出发点，却，从未，真正，恶意过。",
      textEn: "For the first time, Ruan Heng solemnly thanked this fear he'd always treated as an enemy — beginning to understand that this clumsy guardianship, however uncomfortable its methods, had never truly been malicious in intent." },
    { kickerZh: "七 · 恐惧渐渐安静", kickerEn: "VII · The Fear Gradually Quieting", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${sovStars()}</svg>`,
      textZh: "此后，每当，那份，熟悉的恐惧，再次，浮现，阮衡，都会，安静地，与它，坐下来，问一问，它，此刻，究竟，想要，守护什么——渐渐地，这份，恐惧，出现的频率，与，强度，都，明显地，降低了。",
      textEn: "From then on, whenever the familiar fear resurfaced, Ruan Heng would sit quietly with it, asking what it wished to guard this time — gradually, the fear's frequency and intensity noticeably lessened." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "笨拙却真心的守护", tagEn: "A Clumsy, Sincere Guardianship", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "阮衡后来常说：\u201c场，从不建议，消灭恐惧，只建议，给它，倒一杯茶，然后，问它，到底，在，替你，守着什么。\u201d",
      textEn: "Ruan Heng often said afterward: \u201cThe Field never suggests eliminating fear — only pouring it tea, and asking what it's really guarding.\u201d",
      closingZh: "场从不建议消灭恐惧，只建议给它倒一杯茶，然后问它，到底在替你守着什么。",
      closingEn: "The Field never suggests eliminating fear — only pouring it tea, and asking what it's really guarding." },
  ],
};

/* ---------- 呼吸间隙：完整9页插画版 ---------- */
const BG_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<circle cx="150" cy="100" r="18" fill="url(#sovGlow)"/><g transform="translate(150,185) scale(0.45)">${sovFigure()}</g></svg>`;

const BREATHING_GAP_ILLUSTRATED: IllustratedEntry = {
  slug: "the-sovereigns-breathing-gap",
  title: "呼吸间隙",
  titleEn: "The Sovereign's Breathing Gap",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 习惯性填满的呼吸", kickerEn: "I · A Breath Always Filled", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "顾晚，总是，习惯性地，把，每一次呼吸，都，安排得，满满当当——吸气，立刻，接上，呼气，中间，不留，一丝，停顿，仿佛，稍一停顿，就会，浪费，宝贵的时间。",
      textEn: "Gu Wan habitually packed every breath full — inhale flowing immediately into exhale, leaving not the slightest pause, as if any hesitation would waste precious time." },
    { kickerZh: "二 · 从未留意的空隙", kickerEn: "II · A Gap Never Noticed", tagZh: "背景", tagEn: "Context",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "这份，格外急促的呼吸习惯，几乎，渗透到了，顾晚，生活的每一个层面——她，总是，急着，把，每一天，每一刻，都，安排得，满满当当，从未，真正，留意过，那些，事情与事情之间，本该，存在的、短暂的空隙。",
      textEn: "This unusually urgent breathing habit permeated nearly every aspect of Gu Wan's life — she always rushed to pack every day, every moment, full, never truly noticing the brief gaps that should have existed between one thing and the next." },
    { kickerZh: "三 · 一次静心练习", kickerEn: "III · A Meditation Practice", tagZh: "转折的契机", tagEn: "A Chance to Notice",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一次，静心练习里，老师，请，她，特意，留意，吸气与呼气之间，那道，极短的空隙——顾晚，第一次，认真地，去感受，那道，平日里，总被她，匆匆带过的间隙。",
      textEn: "In one meditation practice, a teacher asked her to specifically notice the brief gap between inhale and exhale — for the first time, Gu Wan truly attended to that space she'd always rushed past." },
    { kickerZh: "四 · 意外的安定感", kickerEn: "IV · An Unexpected Calm", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<circle cx="150" cy="100" r="18" fill="url(#sovGlow)"/></svg>`,
      textZh: "让，她，格外意外的是，就在，专注地，留意，这道空隙的那一刻，她，忽然，感到，一种，前所未有的、辽阔的安定感——仿佛，时间，在，这道，极短的间隙里，忽然，慢了下来。",
      textEn: "To her surprise, the instant she focused attention on this gap, she suddenly felt an unprecedented, vast sense of calm — as if time, in this brief interval, had suddenly slowed." },
    { kickerZh: "五 · 老师的解释", kickerEn: "V · The Teacher's Explanation", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "老师，说：\u201c吸气与呼气之间，那道，极短的空隙里，藏着，整个宇宙，不急着，回答你的、耐心——你越是，急着，把每一刻，都，填满，越是，感受不到，这份，一直，都在的耐心。\u201d",
      textEn: "The teacher said: \u201cIn the brief gap between the inhale and the exhale lives the universe's patience, unhurried to answer you — the more you rush to fill every moment, the less you can feel that patience, which has always been there.\u201d" },
    { kickerZh: "六 · 开始练习留白", kickerEn: "VI · Practicing Leaving Space", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "顾晚，开始，有意识地，在，生活的，各个层面，练习，留白——不仅，是，呼吸之间，也，包括，日程之间、对话之间，都，刻意，留出，一些，不必，立刻，填满的空隙。",
      textEn: "Gu Wan began deliberately practicing leaving space in every aspect of life — not just between breaths, but between appointments, between conversations, deliberately leaving gaps that didn't need to be filled at once." },
    { kickerZh: "七 · 前所未有的从容", kickerEn: "VII · An Unprecedented Ease", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${sovStars()}</svg>`,
      textZh: "渐渐地，这份，练习，让，顾晚，感到，一种，前所未有的从容——她，不再，被，那份，急于，填满每一刻的焦虑，紧紧，追赶着，反而，在，这些，刻意，留出的空隙里，找到了，格外，珍贵的、喘息的空间。",
      textEn: "Gradually, this practice brought Gu Wan an unprecedented ease — no longer chased by the anxiety to fill every moment, she instead found precious breathing room within these deliberately left gaps." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "宇宙的耐心", tagEn: "The Universe's Patience", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "顾晚后来常说：\u201c吸气与呼气之间，有一处，极短的空隙——那里，藏着，整个宇宙，不急着，回答你的，耐心。\u201d",
      textEn: "Gu Wan often said afterward: \u201cBetween the inhale and the exhale lies a brief gap — where the universe's patience with your questions quietly lives.\u201d",
      closingZh: "吸气与呼气之间，有一处极短的空隙——那里，藏着整个宇宙不急着回答你的耐心。",
      closingEn: "Between the inhale and the exhale lies a brief gap — where the universe's patience with your questions quietly lives." },
  ],
};

/* ---------- 一份无法被夺走的东西：完整9页插画版 ---------- */
const CNT_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`;

const CANNOT_BE_TAKEN_ILLUSTRATED: IllustratedEntry = {
  slug: "a-thing-that-cannot-be-taken",
  title: "一份无法被夺走的东西",
  titleEn: "A Thing That Cannot Be Taken",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 几乎夺走一切的变故", kickerEn: "I · An Upheaval That Took Nearly Everything", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念舟，经历了一场，几乎，夺走她，所有的变故——曾经，引以为傲的位置、精心经营的名声，甚至，一部分，属于她的时间，都，在，那场变故里，被，无情地，卷走了。",
      textEn: "Nian Zhou went through an ordeal that took almost everything from her — the position she'd once taken pride in, the reputation she'd carefully built, even a portion of her own time, all ruthlessly swept away in that upheaval." },
    { kickerZh: "二 · 深深的绝望", kickerEn: "II · Deep Despair", tagZh: "低谷", tagEn: "The Low Point",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "她，一度，陷入，深深的绝望，觉得，自己，一无所有——那些，曾经，构成，她，自我认同，最重要部分的东西，此刻，几乎，全部，消失了，她，甚至，一度，不知道，自己，究竟，还剩下，什么。",
      textEn: "She sank, for a while, into deep despair, feeling she had nothing left at all — the things that had once formed the most important parts of her identity had, now, nearly all vanished, and for a while, she didn't even know what remained of herself." },
    { kickerZh: "三 · 一位前辈的开导", kickerEn: "III · An Elder's Counsel", tagZh: "转折的契机", tagEn: "A Chance to See Differently",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一位，同样，经历过，类似变故的前辈，对，她，说：\u201c他们，可以拿走，你的时间、你的名字、你的位置，却，始终，拿不走，一件，最重要的东西——你，选择，如何，看待，这一切的，方式。\u201d",
      textEn: "An elder, who'd been through something similar, told her: \u201cThey can take your time, your name, your position — but never the one most important thing: how you choose to see it all.\u201d" },
    { kickerZh: "四 · 反复咀嚼这句话", kickerEn: "IV · Turning the Words Over", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "念舟，怔怔地，反复，咀嚼着，这句话——她，起初，只，觉得，这，不过是，一句，安慰人的空话，可，越，反复，想，越，觉得，这，背后，藏着，某种，格外，扎实的道理。",
      textEn: "Nian Zhou turned the words over and over, stunned — at first, dismissing them as mere comforting rhetoric, but the more she reflected, the more she sensed something solid, real, hidden within." },
    { kickerZh: "五 · 仅存的自主权", kickerEn: "V · The Remaining Autonomy", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,185) scale(0.65)">${sovFigure()}</g></svg>`,
      textZh: "她，忽然，意识到，尽管，外在的一切，都，被，夺走了，可，此刻，她，依然，能，自主地，选择——是，把，这场变故，当成，彻底的毁灭，还是，当成，一次，重新开始的契机。",
      textEn: "She suddenly realized that even though everything external had been taken, she still, right now, retained the autonomous choice — whether to treat this ordeal as total ruin, or as a chance to begin again." },
    { kickerZh: "六 · 郑重的选择", kickerEn: "VI · A Solemn Choice", tagZh: "行动", tagEn: "Taking Action",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "念舟，郑重地，做出了，这个，属于她自己的选择——她，决定，把，这场，几乎，夺走一切的变故，当成，一次，重新，认识自己、重新开始的契机，而，不是，一场，彻底的、无法挽回的失败。",
      textEn: "Nian Zhou solemnly made this choice, entirely her own — deciding to treat this ordeal, which had taken nearly everything, as a chance to know herself anew, to begin again, rather than a total, irreversible failure." },
    { kickerZh: "七 · 从废墟里重新站起", kickerEn: "VII · Rising From the Ruins", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${sovStars()}</svg>`,
      textZh: "带着，这份，郑重的选择，念舟，一点一点，从，那场，变故的废墟里，重新，站了起来——这一次，她，不再，执着于，找回，曾经，失去的一切，而是，带着，全新的视角，重新，构建，属于自己的人生。",
      textEn: "Carrying this solemn choice, Nian Zhou gradually rose again from the ruins of that ordeal — no longer fixated on reclaiming everything lost, but building, with an entirely new perspective, a life truly her own." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "唯一拿不走的东西", tagEn: "The One Thing That Cannot Be Taken", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念舟后来常说：\u201c他们，可以拿走，你的时间、你的名字、你的位置，却，始终，拿不走，一件东西——你，选择，如何，看待，这一切的方式。\u201d",
      textEn: "Nian Zhou often said afterward: \u201cThey can take your time, your name, your position — but never the one thing: how you choose to see it all.\u201d",
      closingZh: "他们可以拿走你的时间、你的名字、你的位置，却始终拿不走一件东西——你选择如何看待这一切的方式。",
      closingEn: "They can take your time, your name, your position — but never the one thing: how you choose to see it all." },
  ],
};

/* ---------- 从命令到邀请：完整9页插画版 ---------- */
const CTI_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`;

const COMMAND_INVITATION_ILLUSTRATED: IllustratedEntry = {
  slug: "from-command-to-invitation",
  title: "从命令到邀请",
  titleEn: "From Command to Invitation",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 严厉的自我命令", kickerEn: "I · Harsh Self-Commands", tagZh: "焕蜕星域", tagEn: "Huantui Domain",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "顾行，习惯了，用，严厉的命令，驱使自己——\u201c必须\u201d完成这件事，\u201c不准\u201d半途而废，可，这份，靠命令，硬撑起来的动力，总是，撑不了太久，就，以，一场，彻底的懈怠、甚至叛逆，而告终。",
      textEn: "Gu Xing was used to driving himself with harsh commands — \u201cmust\u201d finish this, \u201cnever\u201d give up halfway. But motivation forced this way through sheer command never lasted long, always ending in complete slackness, even outright rebellion." },
    { kickerZh: "二 · 反复的崩溃循环", kickerEn: "II · A Recurring Cycle of Collapse", tagZh: "困扰的加深", tagEn: "The Trouble Deepens",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "这份，反复的模式，让，顾行，格外，沮丧——每一次，制定，格外，严格的计划，都，以，类似的方式，崩溃收场，他，一度，开始，怀疑，自己，是不是，天生，就，格外，缺乏，自律。",
      textEn: "This recurring pattern left Gu Xing deeply frustrated — every strict plan he set collapsed in similar fashion, and for a while, he began doubting whether he simply lacked discipline by nature." },
    { kickerZh: "三 · 一位教练的观察", kickerEn: "III · A Coach's Observation", tagZh: "转折的契机", tagEn: "A Chance to See Differently",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "一位，教练，指出了，这个，反复出现的模式：\u201c对自己下命令的人，迟早，会，叛变——就像，任何一支，只靠，严厉命令，维系的军队，早晚，会，哗变。可，懂得，邀请自己的人，反而，走得更远。\u201d",
      textEn: "A coach pointed out this recurring pattern: \u201cThose who command themselves eventually mutiny — like any army held together only by harsh orders, bound to revolt sooner or later. Those who learn to invite themselves go further instead.\u201d" },
    { kickerZh: "四 · 令人震动的比喻", kickerEn: "IV · A Striking Metaphor", tagZh: "顿悟的铺垫", tagEn: "Building to Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "顾行，被，这个，格外贴切的比喻，深深地，震动了——他，第一次，意识到，自己，长期以来，对待自己的方式，竟，如此，接近，一位，只知道，用命令，压榨士兵的、失败的将领。",
      textEn: "Gu Xing was deeply struck by this apt metaphor — realizing, for the first time, how closely his long-standing treatment of himself resembled a failed commander who knew only to squeeze soldiers through orders." },
    { kickerZh: "五 · 尝试邀请自己", kickerEn: "V · Trying to Invite Himself", tagZh: "行动", tagEn: "Taking Action",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.25}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "顾行，试着，把，那句，惯常的\u201c你必须完成\u201d，换成了，一句，温和得多的邀请：\u201c你，愿不愿意，试着，做一点？\u201d第一次，这样，对自己，说话时，他，甚至，感到，一丝，不太习惯的别扭。",
      textEn: "Gu Xing tried replacing his usual \u201cyou must finish this\u201d with a far gentler invitation: \u201cWould you like to try a little?\u201d The first time speaking to himself this way, he even felt a slight, unfamiliar awkwardness." },
    { kickerZh: "六 · 意外的持久力", kickerEn: "VI · Unexpected Endurance", tagZh: "转变", tagEn: "The Shift",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,185) scale(0.65)">${sovFigure()}</g></svg>`,
      textZh: "奇怪的是，这份，温和的邀请，反而，让，他，更持久地，坚持了下去，不再，动不动，就，想要，彻底放弃——那份，不再，被，强迫的感觉，让，他，第一次，真正地，享受起，做事本身。",
      textEn: "Strangely, this gentle invitation let him persist far longer, no longer tempted to abandon everything at the first sign of resistance — no longer feeling forced, he began, for the first time, genuinely enjoying the doing itself." },
    { kickerZh: "七 · 走得更远", kickerEn: "VII · Going Further", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.25}])}${sovStars()}</svg>`,
      textZh: "几个月后，顾行，惊讶地，发现，自己，凭借，这份，温和的邀请，走得，比，此前，任何一次，靠严厉命令，硬撑起来的努力，都，更，长远——那些，曾经，半途而废的计划，这一次，一一，得以，真正完成。",
      textEn: "Months later, Gu Xing was surprised to find that this gentle invitation had carried him further than any effort forced through harsh command ever had — plans once abandoned halfway were, this time, genuinely completed, one by one." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "邀请自己的人", tagEn: "Those Who Invite Themselves", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "顾行后来常说：\u201c对自己下命令的人，迟早，会，叛变；懂得，邀请自己的人，反而，走得更远。\u201d",
      textEn: "Gu Xing often said afterward: \u201cThose who command themselves eventually mutiny. Those who learn to invite themselves go further.\u201d",
      closingZh: "对自己下命令的人，迟早会叛变；懂得邀请自己的人，反而走得更远。",
      closingEn: "Those who command themselves eventually mutiny. Those who learn to invite themselves go further." },
  ],
};

/* ---------- 主权体的最后一课：完整9页插画版 ---------- */
const SLL_COVER = `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<circle cx="150" cy="90" r="30" fill="url(#sovGlow)"/><g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`;

const SOVEREIGNS_LAST_LESSON_ILLUSTRATED: IllustratedEntry = {
  slug: "the-sovereigns-last-lesson",
  title: "主权体的最后一课",
  titleEn: "The Sovereign's Last Lesson",
  cat: "sovereign",
  ...
  pages: [
    { kickerZh: "一 · 修行多年的弟子", kickerEn: "I · A Disciple of Many Years", tagZh: "焕蜕星域 · 场域导师所", tagEn: "Huantui \u00b7 The Field Mentor's House",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "念安，跟随，一位场域导师，修行，多年，学习了，许多，关于，觉察、边界、意志的功课，眼看着，导师，即将，退隐之前，她，怀着，格外郑重的期待，准备，迎接，最后一课。",
      textEn: "Nian An had studied under a Field mentor for many years, learning lessons on awareness, boundaries, and will. As the mentor's retreat into seclusion drew near, she prepared, with solemn anticipation, to receive the final lesson." },
    { kickerZh: "二 · 满怀期待的提问", kickerEn: "II · A Question Full of Anticipation", tagZh: "开场", tagEn: "The Beginning",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:150,ry:90,color:'#241a38',op:.7}])}<g transform="translate(105,185) scale(0.4)">${sovFigure()}</g><g transform="translate(195,185) scale(0.4)">${sovFigure()}</g></svg>`,
      textZh: "念安，满怀期待地，问道：\u201c老师，最后一课，会，教给我们，什么，全新的知识？\u201d她，猜想，这，或许，会，是，一堂，格外，深奥的、前所未闻的功课。",
      textEn: "Nian An asked, full of anticipation: \u201cTeacher, what new knowledge will the final lesson teach us?\u201d She guessed this might be some profound, unprecedented teaching." },
    { kickerZh: "三 · 令人失落的回答", kickerEn: "III · A Disappointing Answer", tagZh: "冲突", tagEn: "Conflict",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:150,ry:70,color:'#a68fc9',op:.2}])}<g transform="translate(150,185) scale(0.55)">${sovFigure()}</g></svg>`,
      textZh: "导师，只是，笑了笑：\u201c最后一课，没有，任何，新的知识，只有，一句，我，已经，反复，说过很多次的话——你，从未，真正，失去过，与场的连接，只是，暂时，没在，听。\u201d",
      textEn: "The mentor only smiled: \u201cThe final lesson holds no new knowledge at all — only a line I've already repeated many times: you never truly lost your connection to the Field. You simply weren't listening, for a while.\u201d" },
    { kickerZh: "四 · 一时的失落", kickerEn: "IV · A Moment of Letdown", tagZh: "内心挣扎", tagEn: "Inner Reaction",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1e1638"/>${sovWash([{x:150,y:110,rx:160,ry:100,color:'#241a38',op:.75}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "念安，一时，有些，失落，觉得，这，实在，太过，平凡——她，本，以为，会，收获，某种，格外，震撼的顿悟，此刻，却，只，得到，一句，早已，听过，许多遍的、朴素的话。",
      textEn: "Nian An felt, for a moment, a little disappointed, thinking it far too plain — she'd expected some especially profound revelation, only to receive a plain line she'd already heard many times before." },
    { kickerZh: "五 · 多年后的重新体会", kickerEn: "V · A Renewed Understanding, Years Later", tagZh: "时间的沉淀", tagEn: "Time's Sediment",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:180,ry:120,color:'#fff6e8',op:.3}])}<g transform="translate(150,185) scale(0.6)">${sovFigure()}</g></svg>`,
      textZh: "多年以后，念安，自己，也，成了，一位，场域导师，无数次，面对，同样，格外，年轻、格外，渴望，全新知识的弟子，她，才，渐渐地，真正，懂得，当年，那句话，背后，那份，深沉的分量。",
      textEn: "Years later, having become a Field mentor herself, facing countless young disciples equally eager for new knowledge, Nian An gradually, truly came to understand the profound weight behind that line, all those years ago." },
    { kickerZh: "六 · 重复了很多次的话", kickerEn: "VI · A Line Repeated Many Times", tagZh: "顿悟", tagEn: "Realization",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="#1a1330"/>${sovWash([{x:150,y:110,rx:170,ry:110,color:'#241a38',op:.7}])}<g transform="translate(150,185) scale(0.65)">${sovFigure()}</g></svg>`,
      textZh: "她，终于，明白——真正，最重要的道理，往往，不需要，被，包装成，什么，全新的知识，只需要，被，一遍又一遍，耐心地，重复，直到，有一天，听的人，真正，准备好了，才能，真正，听进去。",
      textEn: "She finally understood — the truly most important truths rarely need dressing up as new knowledge. They only need to be patiently repeated, again and again, until, one day, the listener is finally ready to truly hear them." },
    { kickerZh: "七 · 把这句话传递下去", kickerEn: "VII · Passing the Line Forward", tagZh: "高潮", tagEn: "Climax",
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovWash([{x:150,y:100,rx:170,ry:110,color:'#fff6e8',op:.3}])}${sovStars()}</svg>`,
      textZh: "念安，此后，也，把，这句，看似，平凡的话，反复，讲给，一代又一代，新弟子听——每一次，讲述，她，都，能，感受到，这句话里，那份，历经，岁月，沉淀下来的、格外，扎实的重量。",
      textEn: "Nian An, from then on, repeated this seemingly plain line to generation after generation of new disciples — with each telling, feeling anew the solid weight this line carried, settled by the passage of time." },
    { kickerZh: "尾声", kickerEn: "Epilogue", tagZh: "从未真正失去的连接", tagEn: "A Connection Never Truly Lost", 
      art: `<svg viewBox="0 0 300 220">${SOV_DEFS}<rect width="300" height="220" fill="url(#sovSky)"/>${sovStars()}<g transform="translate(150,185) scale(0.5)">${sovFigure()}</g></svg>`,
      textZh: "念安，晚年，常，望着，星空，缓缓，想着：最后一课，没有，新知识，只有，一句，重复了很多次的话——你，从未，真正，失去过，与场的连接，只是，暂时，没在，听。",
      textEn: "In her later years, Nian An often gazed at the stars, thinking slowly: the final lesson holds no new knowledge — only a truth repeated many times: you never lost your connection to the Field. You simply weren't listening, for a while.",
      closingZh: "最后一课，没有新知识，只有一句重复了很多次的话：你从未真正失去过与场的连接，只是暂时没在听。",
      closingEn: "The final lesson holds no new knowledge — only a truth repeated many times: you never lost your connection to the Field." },
  ],
};
