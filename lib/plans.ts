...
export const cultivationProducts: Product[] = [
  ...
  { id: "breath", name: "量子呼吸", nameEn: "Quantum Breath", priceUsd: 66, type: "permanent", note: "单次能量交换，永久有效", noteEn: "A single energy exchange — yours forever.", group: "cultivation" },
  { id: "intuition", name: "直觉智能", nameEn: "Intuitive Intelligence", priceUsd: 66, type: "permanent", note: "单次能量交换，永久有效", noteEn: "A single energy exchange — yours forever.", group: "cultivation" },
  { id: "heart-reset", name: "心的重置", nameEn: "Heart Reset", priceUsd: 66, type: "permanent", note: "单次能量交换，永久有效", noteEn: "A single energy exchange — yours forever.", group: "cultivation" },
