...
export const FIELD_PRODUCT_COPY: Record<string, FieldProductCopy> = {
  ...
  "life-archetype": {
    field: "09", layer: "convergence", nameZh: "生命原型", nameEn: "Life Archetype",
    cardDefinitionZh: "让八重场域，在此刻汇成当前生命原型。", cardDefinitionEn: "Let eight fields converge into the life archetype of this moment.",
    keywordsZh: ["八重汇流", "节点相连", "结构张力", "当前原型"], keywordsEn: ["Eight-field Convergence", "Node Links", "Structural Tension", "Current Archetype"],
    ctaZh: "展开我的生命原型 →", ctaEn: "Unfold My Life Archetype →",
    coreTitleZh: "让八重场域，在此刻汇成一幅生命原型", coreTitleEn: "Let eight fields converge into a life archetype for this moment",
    overviewZh: ["生命原型不是第九份孤立测评，而是八个独立场域完成后的汇流层。每个场域留下的有效节点，与本次实时选择重新进入同一张灵犀场树突知识网络。", "系统读取的不是八份结果的简单叠加，而是哪些结构长期存在、最近增强、彼此支撑或形成张力。没有历史记录时形成“当前初始原型”；记录丰富后形成“八重场域汇流原型”。"],
    overviewEn: ["Life Archetype is not a ninth standalone assessment. It is the convergence layer after eight independent fields. Their saved evidence nodes re-enter the Lingxifield Dendritic Knowledge Network with today's choices.", "The system does not simply add eight results. It reads what persists, recently intensifies, reinforces another structure or forms tension. Without history it forms an Initial Current Archetype; with richer evidence it becomes an Eight-field Convergent Archetype."],
    readingZh: "生命原型只读取用户已完成并授权保存的八个场域有效节点，再结合本次实时选择形成当前汇流结构。", readingEn: "Life Archetype reads only completed, user-authorized evidence from eight fields and combines it with present choices into a current convergence structure.",
