...
export const NARRATIVES: Narrative[] = [
  // ───────── 长篇传输 · 小说（6 · $33 · 创作中）─────────
  { slug: "topological-man", title: "拓扑人", titleEn: "Topological Man", cat: "novel", teaser: "一个能感知到自己所有平行版本彼此牵连的人，发现「选择」从来不是删除，而是折叠——每一个没走的岔路，都还在某处呼吸着。", teaserEn: "A man who can feel every parallel version of himself pulling at the others discovers that choice was never deletion, only folding.", price: 33, status: "soon" },
  { slug: "heart-of-the-moon-phase", title: "月相之心", titleEn: "Heart of the Moon Phase", cat: "novel", teaser: "一对灵魂伴侣在月相的十二个周期里反复转世、反复错过，直到他们发现：错过本身，才是这场旅程真正的教材。", teaserEn: "Twin souls reincarnate and miss each other across twelve lunar cycles, until they discover the missing itself was the lesson.", price: 33, status: "soon" },
  { slug: "the-echo-observatory", title: "回声观测站", titleEn: "The Echo Observatory", cat: "novel", teaser: "一座建在维度夹缝里的监听站，专门记录「回声」——那些其实是另一个自己，从未选择的人生里，隔着时间发来的讯息。", teaserEn: "A listening station built in the seams between dimensions, recording echoes that are messages from the selves you never became.", price: 33, status: "soon" },
