...
const originSigns: Omit<LifeSign, "index" | "tier" | "tierIndex">[] = [
  ...
  { nameZh: "灵魂疗愈者", nameEn: "Soul Healer", keywordsZh: "抚慰 · 慈悲 · 修复", keywordsEn: "Comfort · Compassion · Repair", meaningZh: "你的存在本身，就带着一种恢复的力量——身边的人受伤或者低落的时候，会不自觉地想靠近你，不一定说得出为什么。", meaningEn: "Your presence itself carries a restorative quality — people who are hurting instinctively want to be near you, often without being able to say exactly why." },
