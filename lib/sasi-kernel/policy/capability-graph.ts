...
export const SASI_AUTONOMY_VERSION="2026.09.26-kernel-v19";
...
"image-generate-native":{id:"image-generate-native",executionClass:"semantic-generation",localFirst:true,browserEligible:false,deterministic:false,fallbackIds:["image-generate","layout-generate"]},
...
"video-generate-native":{id:"video-generate-native",executionClass:"semantic-generation",localFirst:true,browserEligible:false,deterministic:false,fallbackIds:["video-render","video-compose"]},
...
"semantic-write":{id:"semantic-write",executionClass:"semantic-generation",localFirst:false,browserEligible:false,deterministic:false,fallbackIds:["semantic-reason-native"]},
"semantic-reason":{id:"semantic-reason",executionClass:"semantic-generation",localFirst:false,browserEligible:false,deterministic:false,fallbackIds:["semantic-reason-native","knowledge-retrieve","knowledge-validate"]},
"semantic-reason-native":{id:"semantic-reason-native",executionClass:"semantic-generation",localFirst:true,browserEligible:false,deterministic:false,fallbackIds:["knowledge-retrieve","knowledge-validate"]},
"director-native":{id:"director-native",executionClass:"semantic-generation",localFirst:true,browserEligible:false,deterministic:false,fallbackIds:["video-render"]},
"multimodal-generate":{id:"multimodal-generate",executionClass:"semantic-generation",localFirst:true,browserEligible:false,deterministic:false,fallbackIds:["image-generate-native","video-generate-native","image-generate","video-render"]},
};
...
export function autonomousCoreReadiness(){
 const c=sasiAutonomousCapabilities();
 return{
  version:SASI_AUTONOMY_VERSION,
  capabilityCount:c.length,
  localFirstCount:c.filter(x=>x.localFirst).length,
  deterministicCount:c.filter(x=>x.deterministic).length,
  algorithmRouter:true,
  capabilityGraph:true,
  proceduralImage:true,
  proceduralVideo:true,
