...
const raw: [string, string, string, string][] = [
  ...
  ["心灵", "Inner", "上升之心练到第 9 天，我不再急着改变什么，一切反而开始对齐。", "By day nine of the Ascending Heart, I stopped rushing to change things — and they began to align."],
  ...
  ["关系", "Relationship", "和母亲的心结，在一次「上升之心」后松开了。我们十年来第一次好好说了话。", "A knot with my mother loosened after one Ascending Heart session. We spoke properly for the first time in ten years."],
